...
fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__Closer decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "Commit" selections.onCommit, buildFragment "PullRequest" selections.onPullRequest]
