...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__GitObject r
...
fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__GitObject decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "Blob" selections.onBlob, buildFragment "Commit" selections.onCommit, buildFragment "Tag" selections.onTag, buildFragment "Tree" selections.onTree]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onBlob: pure Nothing, onCommit: pure Nothing, onTag: pure Nothing, onTree: pure Nothing }
