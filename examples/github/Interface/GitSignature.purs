...
signer :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__GitSignature (Maybe r)
signer = selectionForCompositeField "signer" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
wasSignedByGitHub = selectionForField "wasSignedByGitHub" [] graphqlDefaultResponseScalarDecoder

type Fragments decodesTo = { onGpgSignature :: SelectionSet Scope__GpgSignature decodesTo
                           , onSmimeSignature :: SelectionSet Scope__SmimeSignature decodesTo
                           , onUnknownSignature :: SelectionSet Scope__UnknownSignature decodesTo
                           }

fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__GitSignature decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "GpgSignature" selections.onGpgSignature, buildFragment "SmimeSignature" selections.onSmimeSignature, buildFragment "UnknownSignature" selections.onUnknownSignature]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onGpgSignature: pure Nothing, onSmimeSignature: pure Nothing, onUnknownSignature: pure Nothing }
