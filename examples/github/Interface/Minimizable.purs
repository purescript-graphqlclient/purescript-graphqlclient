...
fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__Minimizable decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "CommitComment" selections.onCommitComment, buildFragment "GistComment" selections.onGistComment, buildFragment "IssueComment" selections.onIssueComment, buildFragment "PullRequestReviewComment" selections.onPullRequestReviewComment]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onCommitComment: pure Nothing, onGistComment: pure Nothing, onIssueComment: pure Nothing, onPullRequestReviewComment: pure Nothing }
