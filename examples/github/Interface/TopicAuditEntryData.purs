...
topic :: forall r . SelectionSet Scope__Topic r -> SelectionSet Scope__TopicAuditEntryData (Maybe r)
...
type Fragments decodesTo = { onRepoAddTopicAuditEntry :: SelectionSet Scope__RepoAddTopicAuditEntry decodesTo
                           , onRepoRemoveTopicAuditEntry :: SelectionSet Scope__RepoRemoveTopicAuditEntry decodesTo
                           }

fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__TopicAuditEntryData decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "RepoAddTopicAuditEntry" selections.onRepoAddTopicAuditEntry, buildFragment "RepoRemoveTopicAuditEntry" selections.onRepoRemoveTopicAuditEntry]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onRepoAddTopicAuditEntry: pure Nothing, onRepoRemoveTopicAuditEntry: pure Nothing }
