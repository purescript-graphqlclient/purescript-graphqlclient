...
fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__Closable decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "Issue" selections.onIssue, buildFragment "Milestone" selections.onMilestone, buildFragment "Project" selections.onProject, buildFragment "PullRequest" selections.onPullRequest]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onIssue: pure Nothing, onMilestone: pure Nothing, onProject: pure Nothing, onPullRequest: pure Nothing }
