...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepositoryNode r
...
fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__RepositoryNode decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "CommitComment" selections.onCommitComment, buildFragment "CommitCommentThread" selections.onCommitCommentThread, buildFragment "Issue" selections.onIssue, buildFragment "IssueComment" selections.onIssueComment, buildFragment "PullRequest" selections.onPullRequest, buildFragment "PullRequestCommitCommentThread" selections.onPullRequestCommitCommentThread, buildFragment "PullRequestReview" selections.onPullRequestReview, buildFragment "PullRequestReviewComment" selections.onPullRequestReviewComment, buildFragment "RepositoryVulnerabilityAlert" selections.onRepositoryVulnerabilityAlert]
