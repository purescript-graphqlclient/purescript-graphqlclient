...
fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__MemberStatusable decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "Organization" selections.onOrganization, buildFragment "Team" selections.onTeam]
