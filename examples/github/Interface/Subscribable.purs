...
fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__Subscribable decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "Commit" selections.onCommit, buildFragment "Issue" selections.onIssue, buildFragment "PullRequest" selections.onPullRequest, buildFragment "Repository" selections.onRepository, buildFragment "Team" selections.onTeam, buildFragment "TeamDiscussion" selections.onTeamDiscussion]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onCommit: pure Nothing, onIssue: pure Nothing, onPullRequest: pure Nothing, onRepository: pure Nothing, onTeam: pure Nothing, onTeamDiscussion: pure Nothing }
