...
fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__Starrable decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "Gist" selections.onGist, buildFragment "Repository" selections.onRepository, buildFragment "Topic" selections.onTopic]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onGist: pure Nothing, onRepository: pure Nothing, onTopic: pure Nothing }
