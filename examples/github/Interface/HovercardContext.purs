...
type Fragments decodesTo = { onGenericHovercardContext :: SelectionSet
                                                          Scope__GenericHovercardContext
                                                          decodesTo
                           , onOrganizationTeamsHovercardContext :: SelectionSet
                                                                    Scope__OrganizationTeamsHovercardContext
                                                                    decodesTo
                           , onOrganizationsHovercardContext :: SelectionSet
                                                                Scope__OrganizationsHovercardContext
                                                                decodesTo
                           , onReviewStatusHovercardContext :: SelectionSet
                                                               Scope__ReviewStatusHovercardContext
                                                               decodesTo
                           , onViewerHovercardContext :: SelectionSet
                                                         Scope__ViewerHovercardContext
                                                         decodesTo
                           }
...
fragments selections = exhaustiveFragmentSelection
                       [ buildFragment
                         ...
                         selections.onGenericHovercardContext
                       , buildFragment
                         "OrganizationTeamsHovercardContext"
                         selections.onOrganizationTeamsHovercardContext
                       , buildFragment
                         "OrganizationsHovercardContext"
                         selections.onOrganizationsHovercardContext
                       , buildFragment
                         "ReviewStatusHovercardContext"
                         selections.onReviewStatusHovercardContext
                       , buildFragment
                         "ViewerHovercardContext"
                         selections.onViewerHovercardContext
                       ]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onGenericHovercardContext: pure
                                              Nothing
                 , onOrganizationTeamsHovercardContext: pure
                                                        Nothing
                 , onOrganizationsHovercardContext: pure
                                                    Nothing
                 , onReviewStatusHovercardContext: pure
                                                   Nothing
                 , onViewerHovercardContext: pure
                                             Nothing
                 }
