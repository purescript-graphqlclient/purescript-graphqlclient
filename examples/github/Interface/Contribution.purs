...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__Contribution r
user = selectionForCompositeField "user" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

type Fragments decodesTo = { onCreatedCommitContribution :: SelectionSet Scope__CreatedCommitContribution decodesTo
                           , onCreatedIssueContribution :: SelectionSet Scope__CreatedIssueContribution decodesTo
                           , onCreatedPullRequestContribution :: SelectionSet Scope__CreatedPullRequestContribution decodesTo
                           , onCreatedPullRequestReviewContribution :: SelectionSet Scope__CreatedPullRequestReviewContribution decodesTo
                           , onCreatedRepositoryContribution :: SelectionSet Scope__CreatedRepositoryContribution decodesTo
                           , onJoinedGitHubContribution :: SelectionSet Scope__JoinedGitHubContribution decodesTo
                           , onRestrictedContribution :: SelectionSet Scope__RestrictedContribution decodesTo
                           }

fragments :: forall decodesTo . Fragments decodesTo -> SelectionSet Scope__Contribution decodesTo
fragments selections = exhaustiveFragmentSelection [buildFragment "CreatedCommitContribution" selections.onCreatedCommitContribution, buildFragment "CreatedIssueContribution" selections.onCreatedIssueContribution, buildFragment "CreatedPullRequestContribution" selections.onCreatedPullRequestContribution, buildFragment "CreatedPullRequestReviewContribution" selections.onCreatedPullRequestReviewContribution, buildFragment "CreatedRepositoryContribution" selections.onCreatedRepositoryContribution, buildFragment "JoinedGitHubContribution" selections.onJoinedGitHubContribution, buildFragment "RestrictedContribution" selections.onRestrictedContribution]

maybeFragments :: forall decodesTo . Fragments (Maybe decodesTo)
maybeFragments = { onCreatedCommitContribution: pure Nothing, onCreatedIssueContribution: pure Nothing, onCreatedPullRequestContribution: pure Nothing, onCreatedPullRequestReviewContribution: pure Nothing, onCreatedRepositoryContribution: pure Nothing, onJoinedGitHubContribution: pure Nothing, onRestrictedContribution: pure Nothing }
