...
type Fragments decodesTo = { onCreatedCommitContribution :: SelectionSet
                                                            Scope__CreatedCommitContribution
                                                            decodesTo
                           , onCreatedIssueContribution :: SelectionSet
                                                           Scope__CreatedIssueContribution
                                                           decodesTo
                           , onCreatedPullRequestContribution :: SelectionSet
                                                                 Scope__CreatedPullRequestContribution
                                                                 decodesTo
                           , onCreatedPullRequestReviewContribution :: SelectionSet
                                                                       Scope__CreatedPullRequestReviewContribution
                                                                       decodesTo
                           , onCreatedRepositoryContribution :: SelectionSet
                                                                Scope__CreatedRepositoryContribution
                                                                decodesTo
                           , onJoinedGitHubContribution :: SelectionSet
                                                           Scope__JoinedGitHubContribution
                                                           decodesTo
