...
edges :: forall r . SelectionSet Scope__UserStatusEdge r -> SelectionSet Scope__UserStatusConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__UserStatus r -> SelectionSet Scope__UserStatusConnection (Array (Maybe r))
