module Examples.Github.Object.RepoRemoveMemberAuditEntry where
...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe r)
organization = selectionForCompositeField "organization" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

organizationName :: SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe String)
organizationName = selectionForField "organizationName" [] graphqlDefaultResponseScalarDecoder

organizationResourcePath :: SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe Uri)
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe r)
...
repositoryResourcePath :: SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe Uri)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe r)
...
visibility :: SelectionSet Scope__RepoRemoveMemberAuditEntry (Maybe RepoRemoveMemberAuditEntryVisibility)
