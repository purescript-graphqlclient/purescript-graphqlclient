...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe r)
...
actorResourcePath :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe Uri)
...
isLdapMapped :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe Boolean)
isLdapMapped = selectionForField "isLdapMapped" [] graphqlDefaultResponseScalarDecoder

operationType :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe r)
organization = selectionForCompositeField "organization" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

organizationName :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe String)
organizationName = selectionForField "organizationName" [] graphqlDefaultResponseScalarDecoder

organizationResourcePath :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe Uri)
organizationResourcePath = selectionForField "organizationResourcePath" [] graphqlDefaultResponseScalarDecoder

organizationUrl :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe Uri)
organizationUrl = selectionForField "organizationUrl" [] graphqlDefaultResponseScalarDecoder

repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe r)
repository = selectionForCompositeField "repository" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

repositoryName :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe String)
repositoryName = selectionForField "repositoryName" [] graphqlDefaultResponseScalarDecoder

repositoryResourcePath :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe Uri)
...
team :: forall r . SelectionSet Scope__Team r -> SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe r)
...
teamResourcePath :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe Uri)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe r)
...
userResourcePath :: SelectionSet Scope__TeamRemoveRepositoryAuditEntry (Maybe Uri)
