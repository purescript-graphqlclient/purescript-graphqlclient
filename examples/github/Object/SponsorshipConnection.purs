...
edges :: forall r . SelectionSet Scope__SponsorshipEdge r -> SelectionSet Scope__SponsorshipConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Sponsorship r -> SelectionSet Scope__SponsorshipConnection (Array (Maybe r))
