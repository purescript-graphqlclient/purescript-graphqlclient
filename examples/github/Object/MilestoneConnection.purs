...
edges :: forall r . SelectionSet Scope__MilestoneEdge r -> SelectionSet Scope__MilestoneConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Milestone r -> SelectionSet Scope__MilestoneConnection (Array (Maybe r))
