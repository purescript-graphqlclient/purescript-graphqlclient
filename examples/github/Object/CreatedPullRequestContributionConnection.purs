...
edges :: forall r . SelectionSet Scope__CreatedPullRequestContributionEdge r -> SelectionSet Scope__CreatedPullRequestContributionConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__CreatedPullRequestContribution r -> SelectionSet Scope__CreatedPullRequestContributionConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__CreatedPullRequestContributionConnection r
