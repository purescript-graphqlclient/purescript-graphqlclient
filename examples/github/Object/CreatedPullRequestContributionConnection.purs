...
edges :: forall r . SelectionSet Scope__CreatedPullRequestContributionEdge r -> SelectionSet Scope__CreatedPullRequestContributionConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__CreatedPullRequestContribution r -> SelectionSet Scope__CreatedPullRequestContributionConnection (Array (Maybe r))
