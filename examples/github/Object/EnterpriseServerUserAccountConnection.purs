module Examples.Github.Object.EnterpriseServerUserAccountConnection where
...
edges :: forall r . SelectionSet Scope__EnterpriseServerUserAccountEdge r -> SelectionSet Scope__EnterpriseServerUserAccountConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseServerUserAccount r -> SelectionSet Scope__EnterpriseServerUserAccountConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__EnterpriseServerUserAccountConnection r
