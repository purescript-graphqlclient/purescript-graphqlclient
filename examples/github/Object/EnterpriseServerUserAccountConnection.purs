...
edges :: forall r . SelectionSet Scope__EnterpriseServerUserAccountEdge r -> SelectionSet Scope__EnterpriseServerUserAccountConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseServerUserAccount r -> SelectionSet Scope__EnterpriseServerUserAccountConnection (Array (Maybe r))
