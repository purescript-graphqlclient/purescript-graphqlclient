...
commit :: forall r . SelectionSet Scope__Commit r -> SelectionSet Scope__StatusContext (Maybe r)
...
creator :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__StatusContext (Maybe r)
