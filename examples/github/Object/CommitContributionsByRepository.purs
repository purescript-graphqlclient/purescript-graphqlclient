...
type ContributionsInputRowOptional r = ( after :: Optional String
                                       ...
                                       , first :: Optional Int
                                       , last :: Optional Int
                                       , orderBy :: Optional Examples.Github.InputObject.CommitContributionOrder
                                       | r
                                       )
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__CommitContributionsByRepository r
