...
memberAccessResourcePath = selectionForField "memberAccessResourcePath" [] graphqlDefaultResponseScalarDecoder

memberAccessUrl :: SelectionSet Scope__TeamMemberEdge Uri
memberAccessUrl = selectionForField "memberAccessUrl" [] graphqlDefaultResponseScalarDecoder

node :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__TeamMemberEdge r
