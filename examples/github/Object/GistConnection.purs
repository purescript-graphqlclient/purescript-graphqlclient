...
edges :: forall r . SelectionSet Scope__GistEdge r -> SelectionSet Scope__GistConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Gist r -> SelectionSet Scope__GistConnection (Array (Maybe r))
