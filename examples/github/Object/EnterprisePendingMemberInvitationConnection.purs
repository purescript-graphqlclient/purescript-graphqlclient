...
edges :: forall r . SelectionSet Scope__EnterprisePendingMemberInvitationEdge r -> SelectionSet Scope__EnterprisePendingMemberInvitationConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__OrganizationInvitation r -> SelectionSet Scope__EnterprisePendingMemberInvitationConnection (Array (Maybe r))
