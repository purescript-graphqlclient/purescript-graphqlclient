...
contentType = selectionForField "contentType" [] graphqlDefaultResponseScalarDecoder

createdAt :: SelectionSet Scope__ReleaseAsset DateTime
createdAt = selectionForField "createdAt" [] graphqlDefaultResponseScalarDecoder

downloadCount :: SelectionSet Scope__ReleaseAsset Int
downloadCount = selectionForField "downloadCount" [] graphqlDefaultResponseScalarDecoder

downloadUrl :: SelectionSet Scope__ReleaseAsset Uri
downloadUrl = selectionForField "downloadUrl" [] graphqlDefaultResponseScalarDecoder
...
release :: forall r . SelectionSet Scope__Release r -> SelectionSet Scope__ReleaseAsset (Maybe r)
...
uploadedBy :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__ReleaseAsset r
uploadedBy = selectionForCompositeField "uploadedBy" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
