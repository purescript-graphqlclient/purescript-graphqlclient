...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__AssignedEvent (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__AssignedEvent (Maybe r)
