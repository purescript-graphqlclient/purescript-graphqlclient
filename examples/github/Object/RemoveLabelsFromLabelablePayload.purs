...
clientMutationId :: SelectionSet Scope__RemoveLabelsFromLabelablePayload (Maybe String)
clientMutationId = selectionForField "clientMutationId" [] graphqlDefaultResponseScalarDecoder

labelable :: forall r . SelectionSet Scope__Labelable r -> SelectionSet Scope__RemoveLabelsFromLabelablePayload (Maybe r)
