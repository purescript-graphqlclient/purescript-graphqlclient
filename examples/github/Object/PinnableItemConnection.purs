module Examples.Github.Object.PinnableItemConnection where
...
edges :: forall r . SelectionSet Scope__PinnableItemEdge r -> SelectionSet Scope__PinnableItemConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PinnableItem r -> SelectionSet Scope__PinnableItemConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__PinnableItemConnection r
