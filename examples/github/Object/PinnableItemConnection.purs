...
edges :: forall r . SelectionSet Scope__PinnableItemEdge r -> SelectionSet Scope__PinnableItemConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PinnableItem r -> SelectionSet Scope__PinnableItemConnection (Array (Maybe r))
