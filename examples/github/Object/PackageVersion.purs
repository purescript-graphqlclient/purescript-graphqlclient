...
type FilesInputRowOptional r = ( orderBy :: Optional Examples.Github.InputObject.PackageFileOrder
...
package :: forall r . SelectionSet Scope__Package r -> SelectionSet Scope__PackageVersion (Maybe r)
package = selectionForCompositeField "package" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
preRelease = selectionForField "preRelease" [] graphqlDefaultResponseScalarDecoder
...
release :: forall r . SelectionSet Scope__Release r -> SelectionSet Scope__PackageVersion (Maybe r)
release = selectionForCompositeField "release" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

statistics :: forall r . SelectionSet Scope__PackageVersionStatistics r -> SelectionSet Scope__PackageVersion (Maybe r)
