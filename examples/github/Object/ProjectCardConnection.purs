...
edges :: forall r . SelectionSet Scope__ProjectCardEdge r -> SelectionSet Scope__ProjectCardConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__ProjectCard r -> SelectionSet Scope__ProjectCardConnection (Array (Maybe r))
