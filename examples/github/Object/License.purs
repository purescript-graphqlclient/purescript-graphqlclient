...
conditions :: forall r . SelectionSet Scope__LicenseRule r -> SelectionSet Scope__License (Array (Maybe r))
conditions = selectionForCompositeField "conditions" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
implementation = selectionForField "implementation" [] graphqlDefaultResponseScalarDecoder

key :: SelectionSet Scope__License String
key = selectionForField "key" [] graphqlDefaultResponseScalarDecoder

limitations :: forall r . SelectionSet Scope__LicenseRule r -> SelectionSet Scope__License (Array (Maybe r))
limitations = selectionForCompositeField "limitations" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
permissions :: forall r . SelectionSet Scope__LicenseRule r -> SelectionSet Scope__License (Array (Maybe r))
permissions = selectionForCompositeField "permissions" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pseudoLicense :: SelectionSet Scope__License Boolean
pseudoLicense = selectionForField "pseudoLicense" [] graphqlDefaultResponseScalarDecoder
