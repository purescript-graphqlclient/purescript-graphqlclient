...
edges :: forall r . SelectionSet Scope__UserContentEditEdge r -> SelectionSet Scope__UserContentEditConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__UserContentEdit r -> SelectionSet Scope__UserContentEditConnection (Array (Maybe r))
