module Examples.Github.Object.OrgCreateAuditEntry where
...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__OrgCreateAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__OrgCreateAuditEntry (Maybe r)
...
billingPlan :: SelectionSet Scope__OrgCreateAuditEntry (Maybe OrgCreateAuditEntryBillingPlan)
billingPlan = selectionForField "billingPlan" [] graphqlDefaultResponseScalarDecoder
...
organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__OrgCreateAuditEntry (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrgCreateAuditEntry (Maybe r)
