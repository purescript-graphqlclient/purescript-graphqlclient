module Examples.Github.Object.ReferencedEvent where
...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__ReferencedEvent (Maybe r)
actor = selectionForCompositeField "actor" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

commit :: forall r . SelectionSet Scope__Commit r -> SelectionSet Scope__ReferencedEvent (Maybe r)
commit = selectionForCompositeField "commit" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

commitRepository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__ReferencedEvent r
commitRepository = selectionForCompositeField "commitRepository" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
