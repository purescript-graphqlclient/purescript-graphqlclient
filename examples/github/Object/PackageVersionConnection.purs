...
edges :: forall r . SelectionSet Scope__PackageVersionEdge r -> SelectionSet Scope__PackageVersionConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PackageVersion r -> SelectionSet Scope__PackageVersionConnection (Array (Maybe r))
