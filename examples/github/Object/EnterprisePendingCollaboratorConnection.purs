...
edges :: forall r . SelectionSet Scope__EnterprisePendingCollaboratorEdge r -> SelectionSet Scope__EnterprisePendingCollaboratorConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__EnterprisePendingCollaboratorConnection (Array (Maybe r))
