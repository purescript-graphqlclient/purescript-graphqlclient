...
edges :: forall r . SelectionSet Scope__SponsorsTierEdge r -> SelectionSet Scope__SponsorsTierConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__SponsorsTier r -> SelectionSet Scope__SponsorsTierConnection (Array (Maybe r))
