...
edges :: forall r . SelectionSet Scope__PullRequestChangedFileEdge r -> SelectionSet Scope__PullRequestChangedFileConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PullRequestChangedFile r -> SelectionSet Scope__PullRequestChangedFileConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__PullRequestChangedFileConnection r
