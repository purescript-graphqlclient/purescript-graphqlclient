...
edges :: forall r . SelectionSet Scope__PullRequestChangedFileEdge r -> SelectionSet Scope__PullRequestChangedFileConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PullRequestChangedFile r -> SelectionSet Scope__PullRequestChangedFileConnection (Array (Maybe r))
