...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__LabeledEvent (Maybe r)
...
label :: forall r . SelectionSet Scope__Label r -> SelectionSet Scope__LabeledEvent r
label = selectionForCompositeField "label" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

labelable :: forall r . SelectionSet Scope__Labelable r -> SelectionSet Scope__LabeledEvent r
