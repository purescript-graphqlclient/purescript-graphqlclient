...
edges :: forall r . SelectionSet Scope__CreatedPullRequestReviewContributionEdge r -> SelectionSet Scope__CreatedPullRequestReviewContributionConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__CreatedPullRequestReviewContribution r -> SelectionSet Scope__CreatedPullRequestReviewContributionConnection (Array (Maybe r))
