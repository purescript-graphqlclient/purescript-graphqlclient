...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe r)
...
actorResourcePath :: SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe Uri)
...
invitationEmail :: SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe String)
invitationEmail = selectionForField "invitationEmail" [] graphqlDefaultResponseScalarDecoder

operationType :: SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe r)
organization = selectionForCompositeField "organization" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

organizationName :: SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe String)
organizationName = selectionForField "organizationName" [] graphqlDefaultResponseScalarDecoder

organizationResourcePath :: SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe Uri)
organizationResourcePath = selectionForField "organizationResourcePath" [] graphqlDefaultResponseScalarDecoder

organizationUrl :: SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe Uri)
organizationUrl = selectionForField "organizationUrl" [] graphqlDefaultResponseScalarDecoder

user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe r)
...
userResourcePath :: SelectionSet Scope__OrgAddBillingManagerAuditEntry (Maybe Uri)
