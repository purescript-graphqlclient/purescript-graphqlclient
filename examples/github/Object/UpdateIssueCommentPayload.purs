...
issueComment :: forall r . SelectionSet Scope__IssueComment r -> SelectionSet Scope__UpdateIssueCommentPayload (Maybe r)
issueComment = selectionForCompositeField "issueComment" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
