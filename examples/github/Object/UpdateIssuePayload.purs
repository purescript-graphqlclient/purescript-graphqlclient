...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__UpdateIssuePayload (Maybe r)
...
issue :: forall r . SelectionSet Scope__Issue r -> SelectionSet Scope__UpdateIssuePayload (Maybe r)
