...
edges :: forall r . SelectionSet Scope__UserEdge r -> SelectionSet Scope__FollowerConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__FollowerConnection (Array (Maybe r))
