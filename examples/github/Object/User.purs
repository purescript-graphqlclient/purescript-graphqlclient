...
contributionsCollection :: forall r . ContributionsCollectionInput -> SelectionSet
                                                                      Scope__ContributionsCollection
                                                                      r -> SelectionSet
                                                                           Scope__User
                                                                           r
...
followers :: forall r . FollowersInput -> SelectionSet
                                          Scope__FollowerConnection
                                          r -> SelectionSet
                                               Scope__User
                                               r
...
following :: forall r . FollowingInput -> SelectionSet
                                          Scope__FollowingConnection
                                          r -> SelectionSet
                                               Scope__User
                                               r
...
gist :: forall r . GistInput -> SelectionSet
                                Scope__Gist
                                r -> SelectionSet
                                     Scope__User
                                     (Maybe
...
gistComments :: forall r . GistCommentsInput -> SelectionSet
                                                Scope__GistCommentConnection
                                                r -> SelectionSet
                                                     Scope__User
                                                     r
...
gists :: forall r . GistsInput -> SelectionSet
                                  Scope__GistConnection
                                  r -> SelectionSet
                                       Scope__User
                                       r
...
issueComments :: forall r . IssueCommentsInput -> SelectionSet
                                                  Scope__IssueCommentConnection
                                                  r -> SelectionSet
                                                       Scope__User
                                                       r
...
organizationVerifiedDomainEmails :: OrganizationVerifiedDomainEmailsInput -> SelectionSet
                                                                             Scope__User
                                                                             (Array
                                                                              String)
...
publicKeys :: forall r . PublicKeysInput -> SelectionSet
                                            Scope__PublicKeyConnection
                                            r -> SelectionSet
                                                 Scope__User
                                                 r
...
type RepositoriesContributedToInputRowOptional r = ( privacy :: Optional
                                                                RepositoryPrivacy
                                                   , orderBy :: Optional
                                                                Examples.Github.InputObject.RepositoryOrder
                                                   , isLocked :: Optional
                                                                 Boolean
                                                   , includeUserRepositories :: Optional
                                                                                Boolean
                                                   , contributionTypes :: Optional
                                                                          (Array
                                                                           (Maybe
                                                                            RepositoryContributionType))
                                                   , after :: Optional String
...
repositoriesContributedTo :: forall r . RepositoriesContributedToInput -> SelectionSet
                                                                          Scope__RepositoryConnection
                                                                          r -> SelectionSet
                                                                               Scope__User
                                                                               r
...
savedReplies :: forall r . SavedRepliesInput -> SelectionSet
                                                Scope__SavedReplyConnection
                                                r -> SelectionSet
                                                     Scope__User
                                                     (Maybe
...
starredRepositories :: forall r . StarredRepositoriesInput -> SelectionSet
                                                              Scope__StarredRepositoryConnection
                                                              r -> SelectionSet
                                                                   Scope__User
                                                                   r
...
topRepositories :: forall r . TopRepositoriesInput -> SelectionSet
                                                      Scope__RepositoryConnection
                                                      r -> SelectionSet
                                                           Scope__User
                                                           r
...
watching :: forall r . WatchingInput -> SelectionSet
                                        Scope__RepositoryConnection
                                        r -> SelectionSet
                                             Scope__User
                                             r
