...
edges :: forall r . SelectionSet Scope__PullRequestCommitEdge r -> SelectionSet Scope__PullRequestCommitConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PullRequestCommit r -> SelectionSet Scope__PullRequestCommitConnection (Array (Maybe r))
