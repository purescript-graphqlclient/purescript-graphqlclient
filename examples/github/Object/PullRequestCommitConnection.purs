module Examples.Github.Object.PullRequestCommitConnection where
...
edges :: forall r . SelectionSet Scope__PullRequestCommitEdge r -> SelectionSet Scope__PullRequestCommitConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PullRequestCommit r -> SelectionSet Scope__PullRequestCommitConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__PullRequestCommitConnection r
