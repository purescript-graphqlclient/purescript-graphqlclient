...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe r)
...
actorResourcePath :: SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe Uri)
...
enterpriseResourcePath :: SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe Uri)
enterpriseResourcePath = selectionForField "enterpriseResourcePath" [] graphqlDefaultResponseScalarDecoder

enterpriseSlug :: SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe String)
...
operationType :: SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe r)
organization = selectionForCompositeField "organization" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

organizationName :: SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe String)
organizationName = selectionForField "organizationName" [] graphqlDefaultResponseScalarDecoder

organizationResourcePath :: SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe Uri)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe r)
...
userResourcePath :: SelectionSet Scope__OrgInviteToBusinessAuditEntry (Maybe Uri)
