...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__DeployedEvent (Maybe r)
...
deployment :: forall r . SelectionSet Scope__Deployment r -> SelectionSet Scope__DeployedEvent r
deployment = selectionForCompositeField "deployment" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

id :: SelectionSet Scope__DeployedEvent Id
id = selectionForField "id" [] graphqlDefaultResponseScalarDecoder

pullRequest :: forall r . SelectionSet Scope__PullRequest r -> SelectionSet Scope__DeployedEvent r
pullRequest = selectionForCompositeField "pullRequest" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

ref :: forall r . SelectionSet Scope__Ref r -> SelectionSet Scope__DeployedEvent (Maybe r)
