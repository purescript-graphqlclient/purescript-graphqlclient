module Examples.Github.Object.RepoDestroyAuditEntry where
...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__RepoDestroyAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__RepoDestroyAuditEntry (Maybe r)
...
organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__RepoDestroyAuditEntry (Maybe r)
...
organizationResourcePath :: SelectionSet Scope__RepoDestroyAuditEntry (Maybe Uri)
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepoDestroyAuditEntry (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepoDestroyAuditEntry (Maybe r)
...
visibility :: SelectionSet Scope__RepoDestroyAuditEntry (Maybe RepoDestroyAuditEntryVisibility)
