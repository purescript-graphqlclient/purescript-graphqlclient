...
type CheckRunsInputRowOptional r = ( after :: Optional String
...
checkRuns :: forall r . CheckRunsInput -> SelectionSet
                                          Scope__CheckRunConnection
                                          r -> SelectionSet
                                               Scope__CheckSuite
                                               (Maybe
...
type MatchingPullRequestsInputRowOptional r = ( states :: Optional
                                                          (Array
                                                           PullRequestState)
                                              , labels :: Optional
                                                          (Array
...
matchingPullRequests :: forall r . MatchingPullRequestsInput -> SelectionSet
                                                                Scope__PullRequestConnection
                                                                r -> SelectionSet
                                                                     Scope__CheckSuite
                                                                     (Maybe
