...
edges :: forall r . SelectionSet Scope__ReactingUserEdge r -> SelectionSet Scope__ReactingUserConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__ReactingUserConnection (Array (Maybe r))
