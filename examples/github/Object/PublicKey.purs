...
accessedAt = selectionForField "accessedAt" [] graphqlDefaultResponseScalarDecoder

createdAt :: SelectionSet Scope__PublicKey (Maybe DateTime)
createdAt = selectionForField "createdAt" [] graphqlDefaultResponseScalarDecoder

fingerprint :: SelectionSet Scope__PublicKey String
fingerprint = selectionForField "fingerprint" [] graphqlDefaultResponseScalarDecoder

id :: SelectionSet Scope__PublicKey Id
id = selectionForField "id" [] graphqlDefaultResponseScalarDecoder

isReadOnly :: SelectionSet Scope__PublicKey (Maybe Boolean)
isReadOnly = selectionForField "isReadOnly" [] graphqlDefaultResponseScalarDecoder
