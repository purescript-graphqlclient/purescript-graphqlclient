...
edges :: forall r . SelectionSet Scope__LanguageEdge r -> SelectionSet Scope__LanguageConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Language r -> SelectionSet Scope__LanguageConnection (Array (Maybe r))
