...
blame :: forall r . BlameInput -> SelectionSet
                                  Scope__Blame
                                  r -> SelectionSet
                                       Scope__Commit
                                       r
...
committer :: forall r . SelectionSet
                        Scope__GitActor
                        r -> SelectionSet
                             Scope__Commit
                             (Maybe
...
type HistoryInputRowOptional r = ( after :: Optional String
                                 ...
                                 , author :: Optional
                                             Examples.Github.InputObject.CommitAuthor
...
history :: forall r . HistoryInput -> SelectionSet
                                      Scope__CommitHistoryConnection
                                      r -> SelectionSet
                                           Scope__Commit
                                           r
...
onBehalfOf :: forall r . SelectionSet
                         Scope__Organization
                         r -> SelectionSet
                              Scope__Commit
                              (Maybe
...
parents :: forall r . ParentsInput -> SelectionSet
                                      Scope__CommitConnection
                                      r -> SelectionSet
                                           Scope__Commit
                                           r
...
signature :: forall r . SelectionSet
                        Scope__GitSignature
                        r -> SelectionSet
                             Scope__Commit
                             (Maybe
...
statusCheckRollup :: forall r . SelectionSet
                                Scope__StatusCheckRollup
                                r -> SelectionSet
                                     Scope__Commit
                                     (Maybe
