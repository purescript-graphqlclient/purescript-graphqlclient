module Examples.Github.Object.ReleaseConnection where
...
edges :: forall r . SelectionSet Scope__ReleaseEdge r -> SelectionSet Scope__ReleaseConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Release r -> SelectionSet Scope__ReleaseConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__ReleaseConnection r
