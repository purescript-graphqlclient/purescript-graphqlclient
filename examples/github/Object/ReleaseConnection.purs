...
edges :: forall r . SelectionSet Scope__ReleaseEdge r -> SelectionSet Scope__ReleaseConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Release r -> SelectionSet Scope__ReleaseConnection (Array (Maybe r))
