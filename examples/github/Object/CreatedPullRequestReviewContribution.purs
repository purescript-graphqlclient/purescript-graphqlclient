...
pullRequest :: forall r . SelectionSet Scope__PullRequest r -> SelectionSet Scope__CreatedPullRequestReviewContribution r
pullRequest = selectionForCompositeField "pullRequest" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pullRequestReview :: forall r . SelectionSet Scope__PullRequestReview r -> SelectionSet Scope__CreatedPullRequestReviewContribution r
pullRequestReview = selectionForCompositeField "pullRequestReview" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__CreatedPullRequestReviewContribution r
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__CreatedPullRequestReviewContribution r
