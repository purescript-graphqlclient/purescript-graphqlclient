...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__LockLockablePayload (Maybe r)
...
lockedRecord :: forall r . SelectionSet Scope__Lockable r -> SelectionSet Scope__LockLockablePayload (Maybe r)
lockedRecord = selectionForCompositeField "lockedRecord" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
