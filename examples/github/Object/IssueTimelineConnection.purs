...
edges :: forall r . SelectionSet Scope__IssueTimelineItemEdge r -> SelectionSet Scope__IssueTimelineConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__IssueTimelineItem r -> SelectionSet Scope__IssueTimelineConnection (Array (Maybe r))
