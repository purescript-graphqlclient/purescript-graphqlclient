...
edges :: forall r . SelectionSet Scope__IssueTimelineItemEdge r -> SelectionSet Scope__IssueTimelineConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__IssueTimelineItem r -> SelectionSet Scope__IssueTimelineConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__IssueTimelineConnection r
