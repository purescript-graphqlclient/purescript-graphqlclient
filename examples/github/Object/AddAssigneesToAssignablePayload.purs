...
assignable :: forall r . SelectionSet Scope__Assignable r -> SelectionSet Scope__AddAssigneesToAssignablePayload (Maybe r)
assignable = selectionForCompositeField "assignable" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

clientMutationId :: SelectionSet Scope__AddAssigneesToAssignablePayload (Maybe String)
