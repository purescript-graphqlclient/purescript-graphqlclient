module Examples.Github.Object.RepoAddTopicAuditEntry where
...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__RepoAddTopicAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__RepoAddTopicAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__RepoAddTopicAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__RepoAddTopicAuditEntry (Maybe r)
...
organizationResourcePath :: SelectionSet Scope__RepoAddTopicAuditEntry (Maybe Uri)
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepoAddTopicAuditEntry (Maybe r)
...
topic :: forall r . SelectionSet Scope__Topic r -> SelectionSet Scope__RepoAddTopicAuditEntry (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepoAddTopicAuditEntry (Maybe r)
