...
edges :: forall r . SelectionSet Scope__EnterpriseServerUserAccountsUploadEdge r -> SelectionSet Scope__EnterpriseServerUserAccountsUploadConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseServerUserAccountsUpload r -> SelectionSet Scope__EnterpriseServerUserAccountsUploadConnection (Array (Maybe r))
