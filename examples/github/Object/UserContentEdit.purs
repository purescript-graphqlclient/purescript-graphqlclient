...
deletedBy :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__UserContentEdit (Maybe r)
deletedBy = selectionForCompositeField "deletedBy" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
editor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__UserContentEdit (Maybe r)
