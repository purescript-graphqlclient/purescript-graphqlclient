...
edges :: forall r . SelectionSet Scope__IpAllowListEntryEdge r -> SelectionSet Scope__IpAllowListEntryConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__IpAllowListEntry r -> SelectionSet Scope__IpAllowListEntryConnection (Array (Maybe r))
