...
node :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__EnterpriseAdministratorEdge (Maybe r)
node = selectionForCompositeField "node" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

role :: SelectionSet Scope__EnterpriseAdministratorEdge EnterpriseAdministratorRole
