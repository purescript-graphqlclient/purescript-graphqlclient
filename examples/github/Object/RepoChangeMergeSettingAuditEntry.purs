...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe r)
actorLocation = selectionForCompositeField "actorLocation" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

actorLogin :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe String)
actorLogin = selectionForField "actorLogin" [] graphqlDefaultResponseScalarDecoder

actorResourcePath :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe Uri)
...
createdAt :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry PreciseDateTime
createdAt = selectionForField "createdAt" [] graphqlDefaultResponseScalarDecoder

id :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry Id
id = selectionForField "id" [] graphqlDefaultResponseScalarDecoder

isEnabled :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe Boolean)
isEnabled = selectionForField "isEnabled" [] graphqlDefaultResponseScalarDecoder

mergeType :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe RepoChangeMergeSettingAuditEntryMergeType)
mergeType = selectionForField "mergeType" [] graphqlDefaultResponseScalarDecoder

operationType :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe r)
organization = selectionForCompositeField "organization" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

organizationName :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe String)
organizationName = selectionForField "organizationName" [] graphqlDefaultResponseScalarDecoder

organizationResourcePath :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe Uri)
organizationResourcePath = selectionForField "organizationResourcePath" [] graphqlDefaultResponseScalarDecoder

organizationUrl :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe Uri)
organizationUrl = selectionForField "organizationUrl" [] graphqlDefaultResponseScalarDecoder

repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe r)
repository = selectionForCompositeField "repository" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

repositoryName :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe String)
repositoryName = selectionForField "repositoryName" [] graphqlDefaultResponseScalarDecoder

repositoryResourcePath :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe Uri)
repositoryResourcePath = selectionForField "repositoryResourcePath" [] graphqlDefaultResponseScalarDecoder

repositoryUrl :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe Uri)
repositoryUrl = selectionForField "repositoryUrl" [] graphqlDefaultResponseScalarDecoder

user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe r)
...
userResourcePath :: SelectionSet Scope__RepoChangeMergeSettingAuditEntry (Maybe Uri)
