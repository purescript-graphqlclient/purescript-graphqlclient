...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__UnpinnedEvent (Maybe r)
...
issue :: forall r . SelectionSet Scope__Issue r -> SelectionSet Scope__UnpinnedEvent r
