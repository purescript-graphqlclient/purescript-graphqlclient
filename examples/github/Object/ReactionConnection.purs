...
edges :: forall r . SelectionSet Scope__ReactionEdge r -> SelectionSet Scope__ReactionConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Reaction r -> SelectionSet Scope__ReactionConnection (Array (Maybe r))
