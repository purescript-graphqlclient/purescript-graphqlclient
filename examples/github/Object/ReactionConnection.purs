...
edges :: forall r . SelectionSet Scope__ReactionEdge r -> SelectionSet Scope__ReactionConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Reaction r -> SelectionSet Scope__ReactionConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__ReactionConnection r
...
viewerHasReacted = selectionForField "viewerHasReacted" [] graphqlDefaultResponseScalarDecoder
