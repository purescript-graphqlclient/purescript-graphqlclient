...
edges :: forall r . SelectionSet Scope__TeamDiscussionEdge r -> SelectionSet Scope__TeamDiscussionConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__TeamDiscussion r -> SelectionSet Scope__TeamDiscussionConnection (Array (Maybe r))
