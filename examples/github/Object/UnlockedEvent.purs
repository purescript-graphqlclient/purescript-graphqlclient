...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__UnlockedEvent (Maybe r)
...
lockable :: forall r . SelectionSet Scope__Lockable r -> SelectionSet Scope__UnlockedEvent r
