...
identifiers :: forall r . SelectionSet
                          Scope__SecurityAdvisoryIdentifier
                          r -> SelectionSet
                               Scope__SecurityAdvisory
                               (Array
...
references :: forall r . SelectionSet
                         Scope__SecurityAdvisoryReference
                         r -> SelectionSet
                              Scope__SecurityAdvisory
                              (Array
...
type VulnerabilitiesInputRowOptional r = ( orderBy :: Optional
...
vulnerabilities :: forall r . VulnerabilitiesInput -> SelectionSet
                                                      Scope__SecurityVulnerabilityConnection
                                                      r -> SelectionSet
                                                           Scope__SecurityAdvisory
                                                           r
