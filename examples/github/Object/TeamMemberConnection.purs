...
edges :: forall r . SelectionSet Scope__TeamMemberEdge r -> SelectionSet Scope__TeamMemberConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__TeamMemberConnection (Array (Maybe r))
