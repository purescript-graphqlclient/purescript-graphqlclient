...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__OrgAddMemberAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__OrgAddMemberAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__OrgAddMemberAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__OrgAddMemberAuditEntry (Maybe r)
...
organizationResourcePath :: SelectionSet Scope__OrgAddMemberAuditEntry (Maybe Uri)
...
permission :: SelectionSet Scope__OrgAddMemberAuditEntry (Maybe OrgAddMemberAuditEntryPermission)
permission = selectionForField "permission" [] graphqlDefaultResponseScalarDecoder

user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrgAddMemberAuditEntry (Maybe r)
