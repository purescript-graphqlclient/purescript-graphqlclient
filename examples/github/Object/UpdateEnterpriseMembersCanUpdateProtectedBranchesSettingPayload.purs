...
clientMutationId :: SelectionSet Scope__UpdateEnterpriseMembersCanUpdateProtectedBranchesSettingPayload (Maybe String)
clientMutationId = selectionForField "clientMutationId" [] graphqlDefaultResponseScalarDecoder

enterprise :: forall r . SelectionSet Scope__Enterprise r -> SelectionSet Scope__UpdateEnterpriseMembersCanUpdateProtectedBranchesSettingPayload (Maybe r)
enterprise = selectionForCompositeField "enterprise" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

message :: SelectionSet Scope__UpdateEnterpriseMembersCanUpdateProtectedBranchesSettingPayload (Maybe String)
