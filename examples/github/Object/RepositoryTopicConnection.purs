...
edges :: forall r . SelectionSet Scope__RepositoryTopicEdge r -> SelectionSet Scope__RepositoryTopicConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__RepositoryTopic r -> SelectionSet Scope__RepositoryTopicConnection (Array (Maybe r))
