...
edges :: forall r . SelectionSet Scope__MarketplaceListingEdge r -> SelectionSet Scope__MarketplaceListingConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__MarketplaceListing r -> SelectionSet Scope__MarketplaceListingConnection (Array (Maybe r))
