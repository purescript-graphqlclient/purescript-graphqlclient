module Examples.Github.Object.RepoArchivedAuditEntry where
...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__RepoArchivedAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__RepoArchivedAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__RepoArchivedAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__RepoArchivedAuditEntry (Maybe r)
...
organizationResourcePath :: SelectionSet Scope__RepoArchivedAuditEntry (Maybe Uri)
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepoArchivedAuditEntry (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepoArchivedAuditEntry (Maybe r)
...
visibility :: SelectionSet Scope__RepoArchivedAuditEntry (Maybe RepoArchivedAuditEntryVisibility)
