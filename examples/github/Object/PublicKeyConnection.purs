...
edges :: forall r . SelectionSet Scope__PublicKeyEdge r -> SelectionSet Scope__PublicKeyConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PublicKey r -> SelectionSet Scope__PublicKeyConnection (Array (Maybe r))
