...
clientMutationId :: SelectionSet Scope__DeleteIpAllowListEntryPayload (Maybe String)
clientMutationId = selectionForField "clientMutationId" [] graphqlDefaultResponseScalarDecoder

ipAllowListEntry :: forall r . SelectionSet Scope__IpAllowListEntry r -> SelectionSet Scope__DeleteIpAllowListEntryPayload (Maybe r)
