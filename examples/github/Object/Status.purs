...
type ContextInputRowRequired r = ( name :: String
                                 | r
                                 )

type ContextInput = { | RefsInputRowRequired + () }
...
contexts :: forall r . SelectionSet Scope__StatusContext r -> SelectionSet Scope__Status (Array r)
