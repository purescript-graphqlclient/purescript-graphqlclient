...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__TeamRemoveMemberAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__TeamRemoveMemberAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__TeamRemoveMemberAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__TeamRemoveMemberAuditEntry (Maybe r)
organization = selectionForCompositeField "organization" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

organizationName :: SelectionSet Scope__TeamRemoveMemberAuditEntry (Maybe String)
organizationName = selectionForField "organizationName" [] graphqlDefaultResponseScalarDecoder

organizationResourcePath :: SelectionSet Scope__TeamRemoveMemberAuditEntry (Maybe Uri)
...
team :: forall r . SelectionSet Scope__Team r -> SelectionSet Scope__TeamRemoveMemberAuditEntry (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__TeamRemoveMemberAuditEntry (Maybe r)
