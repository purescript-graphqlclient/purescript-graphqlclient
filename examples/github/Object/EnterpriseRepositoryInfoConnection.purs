module Examples.Github.Object.EnterpriseRepositoryInfoConnection where
...
edges :: forall r . SelectionSet Scope__EnterpriseRepositoryInfoEdge r -> SelectionSet Scope__EnterpriseRepositoryInfoConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseRepositoryInfo r -> SelectionSet Scope__EnterpriseRepositoryInfoConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__EnterpriseRepositoryInfoConnection r
