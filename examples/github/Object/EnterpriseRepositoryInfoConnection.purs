...
edges :: forall r . SelectionSet Scope__EnterpriseRepositoryInfoEdge r -> SelectionSet Scope__EnterpriseRepositoryInfoConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseRepositoryInfo r -> SelectionSet Scope__EnterpriseRepositoryInfoConnection (Array (Maybe r))
