module Examples.Github.Object.EnterpriseUserAccountConnection where
...
edges :: forall r . SelectionSet Scope__EnterpriseUserAccountEdge r -> SelectionSet Scope__EnterpriseUserAccountConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseUserAccount r -> SelectionSet Scope__EnterpriseUserAccountConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__EnterpriseUserAccountConnection r
