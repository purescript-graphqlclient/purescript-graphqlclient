...
countryCode = selectionForField "countryCode" [] graphqlDefaultResponseScalarDecoder
...
regionCode = selectionForField "regionCode" [] graphqlDefaultResponseScalarDecoder
