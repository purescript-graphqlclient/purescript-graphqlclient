...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__OrgInviteMemberAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__OrgInviteMemberAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__OrgInviteMemberAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__OrgInviteMemberAuditEntry (Maybe r)
organization = selectionForCompositeField "organization" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

organizationInvitation :: forall r . SelectionSet Scope__OrganizationInvitation r -> SelectionSet Scope__OrgInviteMemberAuditEntry (Maybe r)
...
organizationResourcePath :: SelectionSet Scope__OrgInviteMemberAuditEntry (Maybe Uri)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrgInviteMemberAuditEntry (Maybe r)
