...
column :: forall r . SelectionSet Scope__ProjectColumn r -> SelectionSet Scope__DeleteProjectCardPayload (Maybe r)
...
deletedCardId = selectionForField "deletedCardId" [] graphqlDefaultResponseScalarDecoder
