...
adminInfo :: forall r . SelectionSet Scope__SponsorsTierAdminInfo r -> SelectionSet Scope__SponsorsTier (Maybe r)
adminInfo = selectionForCompositeField "adminInfo" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
monthlyPriceInCents = selectionForField "monthlyPriceInCents" [] graphqlDefaultResponseScalarDecoder

monthlyPriceInDollars :: SelectionSet Scope__SponsorsTier Int
monthlyPriceInDollars = selectionForField "monthlyPriceInDollars" [] graphqlDefaultResponseScalarDecoder

name :: SelectionSet Scope__SponsorsTier String
name = selectionForField "name" [] graphqlDefaultResponseScalarDecoder

sponsorsListing :: forall r . SelectionSet Scope__SponsorsListing r -> SelectionSet Scope__SponsorsTier r
