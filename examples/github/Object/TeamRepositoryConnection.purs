...
edges :: forall r . SelectionSet Scope__TeamRepositoryEdge r -> SelectionSet Scope__TeamRepositoryConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__TeamRepositoryConnection (Array (Maybe r))
