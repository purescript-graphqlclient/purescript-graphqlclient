...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__OrgBlockUserAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__OrgBlockUserAuditEntry (Maybe r)
...
blockedUser :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrgBlockUserAuditEntry (Maybe r)
...
blockedUserResourcePath :: SelectionSet Scope__OrgBlockUserAuditEntry (Maybe Uri)
...
operationType :: SelectionSet Scope__OrgBlockUserAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__OrgBlockUserAuditEntry (Maybe r)
...
organizationResourcePath :: SelectionSet Scope__OrgBlockUserAuditEntry (Maybe Uri)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrgBlockUserAuditEntry (Maybe r)
