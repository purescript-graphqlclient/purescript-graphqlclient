...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__RepoCreateAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__RepoCreateAuditEntry (Maybe r)
...
forkParentName = selectionForField "forkParentName" [] graphqlDefaultResponseScalarDecoder

forkSourceName :: SelectionSet Scope__RepoCreateAuditEntry (Maybe String)
forkSourceName = selectionForField "forkSourceName" [] graphqlDefaultResponseScalarDecoder
...
organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__RepoCreateAuditEntry (Maybe r)
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepoCreateAuditEntry (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepoCreateAuditEntry (Maybe r)
...
visibility :: SelectionSet Scope__RepoCreateAuditEntry (Maybe RepoCreateAuditEntryVisibility)
