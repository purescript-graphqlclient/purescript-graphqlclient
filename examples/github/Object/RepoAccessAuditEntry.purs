...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__RepoAccessAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__RepoAccessAuditEntry (Maybe r)
...
organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__RepoAccessAuditEntry (Maybe r)
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepoAccessAuditEntry (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepoAccessAuditEntry (Maybe r)
...
visibility :: SelectionSet Scope__RepoAccessAuditEntry (Maybe RepoAccessAuditEntryVisibility)
