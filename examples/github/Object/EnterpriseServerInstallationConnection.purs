...
edges :: forall r . SelectionSet Scope__EnterpriseServerInstallationEdge r -> SelectionSet Scope__EnterpriseServerInstallationConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseServerInstallation r -> SelectionSet Scope__EnterpriseServerInstallationConnection (Array (Maybe r))
