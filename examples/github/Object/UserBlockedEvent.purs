...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__UserBlockedEvent (Maybe r)
...
blockDuration = selectionForField "blockDuration" [] graphqlDefaultResponseScalarDecoder
...
subject :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__UserBlockedEvent (Maybe r)
