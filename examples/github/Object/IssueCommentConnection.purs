...
edges :: forall r . SelectionSet Scope__IssueCommentEdge r -> SelectionSet Scope__IssueCommentConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__IssueComment r -> SelectionSet Scope__IssueCommentConnection (Array (Maybe r))
