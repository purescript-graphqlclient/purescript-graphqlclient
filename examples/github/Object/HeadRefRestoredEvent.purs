...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__HeadRefRestoredEvent (Maybe r)
...
pullRequest :: forall r . SelectionSet Scope__PullRequest r -> SelectionSet Scope__HeadRefRestoredEvent r
