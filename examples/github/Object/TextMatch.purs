...
highlights :: forall r . SelectionSet Scope__TextMatchHighlight r -> SelectionSet Scope__TextMatch (Array r)
highlights = selectionForCompositeField "highlights" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
