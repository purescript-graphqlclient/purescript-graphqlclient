...
clientMutationId :: SelectionSet Scope__ClearLabelsFromLabelablePayload (Maybe String)
clientMutationId = selectionForField "clientMutationId" [] graphqlDefaultResponseScalarDecoder

labelable :: forall r . SelectionSet Scope__Labelable r -> SelectionSet Scope__ClearLabelsFromLabelablePayload (Maybe r)
