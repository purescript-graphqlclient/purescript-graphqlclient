module Examples.Github.Object.RepositoryConnection where
...
edges :: forall r . SelectionSet Scope__RepositoryEdge r -> SelectionSet Scope__RepositoryConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepositoryConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__RepositoryConnection r
...
totalDiskUsage = selectionForField "totalDiskUsage" [] graphqlDefaultResponseScalarDecoder
