...
edges :: forall r . SelectionSet Scope__PullRequestEdge r -> SelectionSet Scope__PullRequestConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PullRequest r -> SelectionSet Scope__PullRequestConnection (Array (Maybe r))
