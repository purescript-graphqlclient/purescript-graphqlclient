...
edges :: forall r . SelectionSet Scope__CreatedCommitContributionEdge r -> SelectionSet Scope__CreatedCommitContributionConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__CreatedCommitContribution r -> SelectionSet Scope__CreatedCommitContributionConnection (Array (Maybe r))
