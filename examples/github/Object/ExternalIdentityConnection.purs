...
edges :: forall r . SelectionSet Scope__ExternalIdentityEdge r -> SelectionSet Scope__ExternalIdentityConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__ExternalIdentity r -> SelectionSet Scope__ExternalIdentityConnection (Array (Maybe r))
