module Examples.Github.Object.ExternalIdentityConnection where
...
edges :: forall r . SelectionSet Scope__ExternalIdentityEdge r -> SelectionSet Scope__ExternalIdentityConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__ExternalIdentity r -> SelectionSet Scope__ExternalIdentityConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__ExternalIdentityConnection r
