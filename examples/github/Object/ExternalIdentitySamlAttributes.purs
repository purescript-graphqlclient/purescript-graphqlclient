...
emails :: forall r . SelectionSet Scope__UserEmailMetadata r -> SelectionSet Scope__ExternalIdentitySamlAttributes (Maybe (Array r))
...
groups :: SelectionSet Scope__ExternalIdentitySamlAttributes (Maybe (Array String))
