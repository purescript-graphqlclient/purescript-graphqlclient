...
edges :: forall r . SelectionSet Scope__EnterpriseServerUserAccountEmailEdge r -> SelectionSet Scope__EnterpriseServerUserAccountEmailConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseServerUserAccountEmail r -> SelectionSet Scope__EnterpriseServerUserAccountEmailConnection (Array (Maybe r))
