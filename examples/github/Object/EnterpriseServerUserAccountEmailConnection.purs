...
edges :: forall r . SelectionSet Scope__EnterpriseServerUserAccountEmailEdge r -> SelectionSet Scope__EnterpriseServerUserAccountEmailConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseServerUserAccountEmail r -> SelectionSet Scope__EnterpriseServerUserAccountEmailConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__EnterpriseServerUserAccountEmailConnection r
