...
author :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__TeamDiscussionComment (Maybe r)
author = selectionForCompositeField "author" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

authorAssociation :: SelectionSet Scope__TeamDiscussionComment CommentAuthorAssociation
...
discussion :: forall r . SelectionSet Scope__TeamDiscussion r -> SelectionSet Scope__TeamDiscussionComment r
discussion = selectionForCompositeField "discussion" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

editor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__TeamDiscussionComment (Maybe r)
...
reactionGroups :: forall r . SelectionSet Scope__ReactionGroup r -> SelectionSet Scope__TeamDiscussionComment (Maybe (Array r))
...
reactions :: forall r . ReactionsInput -> SelectionSet Scope__ReactionConnection r -> SelectionSet Scope__TeamDiscussionComment r
...
userContentEdits :: forall r . UserContentEditsInput -> SelectionSet Scope__UserContentEditConnection r -> SelectionSet Scope__TeamDiscussionComment (Maybe r)
...
viewerCannotUpdateReasons :: SelectionSet Scope__TeamDiscussionComment (Array CommentCannotUpdateReason)
