...
enterprise :: forall r . SelectionSet Scope__Enterprise r -> SelectionSet Scope__EnterpriseAdministratorInvitation r
...
invitee :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__EnterpriseAdministratorInvitation (Maybe r)
invitee = selectionForCompositeField "invitee" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

inviter :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__EnterpriseAdministratorInvitation (Maybe r)
inviter = selectionForCompositeField "inviter" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

role :: SelectionSet Scope__EnterpriseAdministratorInvitation EnterpriseAdministratorRole
