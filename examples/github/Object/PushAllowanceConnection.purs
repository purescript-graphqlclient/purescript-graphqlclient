...
edges :: forall r . SelectionSet Scope__PushAllowanceEdge r -> SelectionSet Scope__PushAllowanceConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PushAllowance r -> SelectionSet Scope__PushAllowanceConnection (Array (Maybe r))
