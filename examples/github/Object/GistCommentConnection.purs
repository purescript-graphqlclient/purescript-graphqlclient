...
edges :: forall r . SelectionSet Scope__GistCommentEdge r -> SelectionSet Scope__GistCommentConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__GistComment r -> SelectionSet Scope__GistCommentConnection (Array (Maybe r))
