...
edges :: forall r . SelectionSet Scope__EnterpriseOrganizationMembershipEdge r -> SelectionSet Scope__EnterpriseOrganizationMembershipConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__EnterpriseOrganizationMembershipConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__EnterpriseOrganizationMembershipConnection r
