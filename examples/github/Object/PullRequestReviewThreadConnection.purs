module Examples.Github.Object.PullRequestReviewThreadConnection where
...
edges :: forall r . SelectionSet Scope__PullRequestReviewThreadEdge r -> SelectionSet Scope__PullRequestReviewThreadConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PullRequestReviewThread r -> SelectionSet Scope__PullRequestReviewThreadConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__PullRequestReviewThreadConnection r
