...
edges :: forall r . SelectionSet Scope__PullRequestReviewThreadEdge r -> SelectionSet Scope__PullRequestReviewThreadConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PullRequestReviewThread r -> SelectionSet Scope__PullRequestReviewThreadConnection (Array (Maybe r))
