...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__OrgRestoreMemberMembershipRepositoryAuditEntryData (Maybe r)
repository = selectionForCompositeField "repository" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

repositoryName :: SelectionSet Scope__OrgRestoreMemberMembershipRepositoryAuditEntryData (Maybe String)
repositoryName = selectionForField "repositoryName" [] graphqlDefaultResponseScalarDecoder

repositoryResourcePath :: SelectionSet Scope__OrgRestoreMemberMembershipRepositoryAuditEntryData (Maybe Uri)
repositoryResourcePath = selectionForField "repositoryResourcePath" [] graphqlDefaultResponseScalarDecoder

repositoryUrl :: SelectionSet Scope__OrgRestoreMemberMembershipRepositoryAuditEntryData (Maybe Uri)
