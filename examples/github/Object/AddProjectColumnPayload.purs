...
columnEdge :: forall r . SelectionSet Scope__ProjectColumnEdge r -> SelectionSet Scope__AddProjectColumnPayload (Maybe r)
columnEdge = selectionForCompositeField "columnEdge" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

project :: forall r . SelectionSet Scope__Project r -> SelectionSet Scope__AddProjectColumnPayload (Maybe r)
