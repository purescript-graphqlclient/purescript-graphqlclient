...
issue :: forall r . SelectionSet Scope__Issue r -> SelectionSet Scope__CreatedIssueContribution r
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__CreatedIssueContribution r
