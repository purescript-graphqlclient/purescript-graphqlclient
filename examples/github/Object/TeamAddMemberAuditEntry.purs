...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__TeamAddMemberAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__TeamAddMemberAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__TeamAddMemberAuditEntry (Maybe r)
...
organizationResourcePath :: SelectionSet Scope__TeamAddMemberAuditEntry (Maybe Uri)
...
team :: forall r . SelectionSet Scope__Team r -> SelectionSet Scope__TeamAddMemberAuditEntry (Maybe r)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__TeamAddMemberAuditEntry (Maybe r)
