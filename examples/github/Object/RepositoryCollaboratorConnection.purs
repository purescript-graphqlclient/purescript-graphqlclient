...
edges :: forall r . SelectionSet Scope__RepositoryCollaboratorEdge r -> SelectionSet Scope__RepositoryCollaboratorConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepositoryCollaboratorConnection (Array (Maybe r))
