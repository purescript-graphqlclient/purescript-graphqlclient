...
digestMethod :: SelectionSet Scope__EnterpriseIdentityProvider (Maybe SamlDigestAlgorithm)
...
idpCertificate :: SelectionSet Scope__EnterpriseIdentityProvider (Maybe X509Certificate)
