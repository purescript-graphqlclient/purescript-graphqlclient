...
author :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__IssueComment (Maybe r)
...
editor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__IssueComment (Maybe r)
...
issue :: forall r . SelectionSet Scope__Issue r -> SelectionSet Scope__IssueComment r
...
reactions :: forall r . ReactionsInput -> SelectionSet Scope__ReactionConnection r -> SelectionSet Scope__IssueComment r
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__IssueComment r
...
userContentEdits :: forall r . UserContentEditsInput -> SelectionSet Scope__UserContentEditConnection r -> SelectionSet Scope__IssueComment (Maybe r)
...
viewerCannotUpdateReasons :: SelectionSet Scope__IssueComment (Array CommentCannotUpdateReason)
