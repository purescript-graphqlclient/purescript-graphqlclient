...
edges :: forall r . SelectionSet Scope__CommitEdge r -> SelectionSet Scope__CommitHistoryConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Commit r -> SelectionSet Scope__CommitHistoryConnection (Array (Maybe r))
