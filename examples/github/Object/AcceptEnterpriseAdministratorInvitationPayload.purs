...
clientMutationId :: SelectionSet Scope__AcceptEnterpriseAdministratorInvitationPayload (Maybe String)
clientMutationId = selectionForField "clientMutationId" [] graphqlDefaultResponseScalarDecoder

invitation :: forall r . SelectionSet Scope__EnterpriseAdministratorInvitation r -> SelectionSet Scope__AcceptEnterpriseAdministratorInvitationPayload (Maybe r)
invitation = selectionForCompositeField "invitation" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

message :: SelectionSet Scope__AcceptEnterpriseAdministratorInvitationPayload (Maybe String)
