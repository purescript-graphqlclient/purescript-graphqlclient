...
edges :: forall r . SelectionSet Scope__EnterpriseOutsideCollaboratorEdge r -> SelectionSet Scope__EnterpriseOutsideCollaboratorConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__EnterpriseOutsideCollaboratorConnection (Array (Maybe r))
