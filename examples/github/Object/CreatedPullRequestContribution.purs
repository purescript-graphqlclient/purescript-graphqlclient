...
pullRequest :: forall r . SelectionSet Scope__PullRequest r -> SelectionSet Scope__CreatedPullRequestContribution r
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__CreatedPullRequestContribution r
