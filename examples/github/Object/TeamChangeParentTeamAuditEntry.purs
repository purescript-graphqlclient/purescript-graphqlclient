...
parentTeam :: forall r . SelectionSet
                         Scope__Team
                         r -> SelectionSet
                              Scope__TeamChangeParentTeamAuditEntry
                              (Maybe
...
parentTeamName :: SelectionSet
                  Scope__TeamChangeParentTeamAuditEntry
                  (Maybe
                   String)
parentTeamName = selectionForField
                 "parentTeamName"
                 []
                 graphqlDefaultResponseScalarDecoder

parentTeamNameWas :: SelectionSet
                     Scope__TeamChangeParentTeamAuditEntry
                     (Maybe
                      String)
parentTeamNameWas = selectionForField
                    "parentTeamNameWas"
                    []
                    graphqlDefaultResponseScalarDecoder

parentTeamResourcePath :: SelectionSet
                          Scope__TeamChangeParentTeamAuditEntry
                          (Maybe
                           Uri)
parentTeamResourcePath = selectionForField
                         "parentTeamResourcePath"
                         []
                         graphqlDefaultResponseScalarDecoder

parentTeamUrl :: SelectionSet Scope__TeamChangeParentTeamAuditEntry (Maybe Uri)
parentTeamUrl = selectionForField
                "parentTeamUrl"
                []
                graphqlDefaultResponseScalarDecoder

parentTeamWas :: forall r . SelectionSet
                            Scope__Team
                            r -> SelectionSet
                                 Scope__TeamChangeParentTeamAuditEntry
                                 (Maybe
                                  r)
parentTeamWas = selectionForCompositeField
                "parentTeamWas"
                []
                graphqlDefaultResponseFunctorOrScalarDecoderTransformer

parentTeamWasResourcePath :: SelectionSet
                             Scope__TeamChangeParentTeamAuditEntry
                             (Maybe
                              Uri)
parentTeamWasResourcePath = selectionForField
                            "parentTeamWasResourcePath"
                            []
                            graphqlDefaultResponseScalarDecoder

parentTeamWasUrl :: SelectionSet
                    Scope__TeamChangeParentTeamAuditEntry
                    (Maybe
                     Uri)
parentTeamWasUrl = selectionForField
                   "parentTeamWasUrl"
                   []
                   graphqlDefaultResponseScalarDecoder
