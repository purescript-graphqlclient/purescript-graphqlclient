...
edges :: forall r . SelectionSet Scope__ProjectEdge r -> SelectionSet Scope__ProjectConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Project r -> SelectionSet Scope__ProjectConnection (Array (Maybe r))
