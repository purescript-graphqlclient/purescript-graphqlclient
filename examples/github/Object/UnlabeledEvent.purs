...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__UnlabeledEvent (Maybe r)
...
label :: forall r . SelectionSet Scope__Label r -> SelectionSet Scope__UnlabeledEvent r
label = selectionForCompositeField "label" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

labelable :: forall r . SelectionSet Scope__Labelable r -> SelectionSet Scope__UnlabeledEvent r
