...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe r)
organization = selectionForCompositeField "organization" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

organizationName :: SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe String)
organizationName = selectionForField "organizationName" [] graphqlDefaultResponseScalarDecoder

organizationResourcePath :: SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe Uri)
...
restoredCustomEmailRoutingsCount :: SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe Int)
restoredCustomEmailRoutingsCount = selectionForField "restoredCustomEmailRoutingsCount" [] graphqlDefaultResponseScalarDecoder
...
restoredMemberships :: forall r . SelectionSet Scope__OrgRestoreMemberAuditEntryMembership r -> SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe (Array r))
...
restoredRepositoriesCount :: SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe Int)
restoredRepositoriesCount = selectionForField "restoredRepositoriesCount" [] graphqlDefaultResponseScalarDecoder

restoredRepositoryStarsCount :: SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe Int)
restoredRepositoryStarsCount = selectionForField "restoredRepositoryStarsCount" [] graphqlDefaultResponseScalarDecoder

restoredRepositoryWatchesCount :: SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe Int)
restoredRepositoryWatchesCount = selectionForField "restoredRepositoryWatchesCount" [] graphqlDefaultResponseScalarDecoder

user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe r)
