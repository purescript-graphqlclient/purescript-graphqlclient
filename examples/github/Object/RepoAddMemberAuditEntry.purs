...
actor :: forall r . SelectionSet Scope__AuditEntryActor r -> SelectionSet Scope__RepoAddMemberAuditEntry (Maybe r)
...
actorLocation :: forall r . SelectionSet Scope__ActorLocation r -> SelectionSet Scope__RepoAddMemberAuditEntry (Maybe r)
...
operationType :: SelectionSet Scope__RepoAddMemberAuditEntry (Maybe OperationType)
operationType = selectionForField "operationType" [] graphqlDefaultResponseScalarDecoder

organization :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__RepoAddMemberAuditEntry (Maybe r)
...
organizationResourcePath :: SelectionSet Scope__RepoAddMemberAuditEntry (Maybe Uri)
...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__RepoAddMemberAuditEntry (Maybe r)
...
repositoryResourcePath :: SelectionSet Scope__RepoAddMemberAuditEntry (Maybe Uri)
...
user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RepoAddMemberAuditEntry (Maybe r)
...
visibility :: SelectionSet Scope__RepoAddMemberAuditEntry (Maybe RepoAddMemberAuditEntryVisibility)
