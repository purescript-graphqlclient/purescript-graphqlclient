...
edges :: forall r . SelectionSet Scope__BranchProtectionRuleConflictEdge r -> SelectionSet Scope__BranchProtectionRuleConflictConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__BranchProtectionRuleConflict r -> SelectionSet Scope__BranchProtectionRuleConflictConnection (Array (Maybe r))
