...
edges :: forall r . SelectionSet Scope__SecurityAdvisoryEdge r -> SelectionSet Scope__SecurityAdvisoryConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__SecurityAdvisory r -> SelectionSet Scope__SecurityAdvisoryConnection (Array (Maybe r))
