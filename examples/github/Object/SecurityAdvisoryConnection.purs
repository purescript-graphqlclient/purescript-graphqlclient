...
edges :: forall r . SelectionSet Scope__SecurityAdvisoryEdge r -> SelectionSet Scope__SecurityAdvisoryConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__SecurityAdvisory r -> SelectionSet Scope__SecurityAdvisoryConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__SecurityAdvisoryConnection r
