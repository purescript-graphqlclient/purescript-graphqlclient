...
edges :: forall r . SelectionSet Scope__EnterpriseAdministratorEdge r -> SelectionSet Scope__EnterpriseAdministratorConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__EnterpriseAdministratorConnection (Array (Maybe r))
