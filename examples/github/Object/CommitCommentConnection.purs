...
edges :: forall r . SelectionSet Scope__CommitCommentEdge r -> SelectionSet Scope__CommitCommentConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__CommitComment r -> SelectionSet Scope__CommitCommentConnection (Array (Maybe r))
