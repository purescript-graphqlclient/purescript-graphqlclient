module Examples.Github.Object.Reaction where
...
reactable :: forall r . SelectionSet Scope__Reactable r -> SelectionSet Scope__Reaction r
reactable = selectionForCompositeField "reactable" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

user :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__Reaction (Maybe r)
