module Examples.Github.Object.IssueConnection where
...
edges :: forall r . SelectionSet Scope__IssueEdge r -> SelectionSet Scope__IssueConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Issue r -> SelectionSet Scope__IssueConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__IssueConnection r
