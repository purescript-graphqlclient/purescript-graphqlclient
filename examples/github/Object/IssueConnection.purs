...
edges :: forall r . SelectionSet Scope__IssueEdge r -> SelectionSet Scope__IssueConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Issue r -> SelectionSet Scope__IssueConnection (Array (Maybe r))
