...
hasTwoFactorEnabled :: SelectionSet Scope__OrganizationMemberEdge (Maybe Boolean)
hasTwoFactorEnabled = selectionForField "hasTwoFactorEnabled" [] graphqlDefaultResponseScalarDecoder

node :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrganizationMemberEdge (Maybe r)
node = selectionForCompositeField "node" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

role :: SelectionSet Scope__OrganizationMemberEdge (Maybe OrganizationMemberRole)
