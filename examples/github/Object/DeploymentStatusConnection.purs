...
edges :: forall r . SelectionSet Scope__DeploymentStatusEdge r -> SelectionSet Scope__DeploymentStatusConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__DeploymentStatus r -> SelectionSet Scope__DeploymentStatusConnection (Array (Maybe r))
