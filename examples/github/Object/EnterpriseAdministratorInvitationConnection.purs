...
edges :: forall r . SelectionSet Scope__EnterpriseAdministratorInvitationEdge r -> SelectionSet Scope__EnterpriseAdministratorInvitationConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__EnterpriseAdministratorInvitation r -> SelectionSet Scope__EnterpriseAdministratorInvitationConnection (Array (Maybe r))
