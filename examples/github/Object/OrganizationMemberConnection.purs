...
edges :: forall r . SelectionSet Scope__OrganizationMemberEdge r -> SelectionSet Scope__OrganizationMemberConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__OrganizationMemberConnection (Array (Maybe r))
