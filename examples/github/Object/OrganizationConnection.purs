...
edges :: forall r . SelectionSet Scope__OrganizationEdge r -> SelectionSet Scope__OrganizationConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Organization r -> SelectionSet Scope__OrganizationConnection (Array (Maybe r))
