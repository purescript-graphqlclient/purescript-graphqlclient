...
type IssueInputRowRequired r = ( number :: Int
                               | r
                               )
...
type IssueOrPullRequestInputRowRequired r = ( number :: Int
                                            | r
                                            )
...
type LabelInputRowRequired r = ( name :: String
                               | r
                               )
...
type MilestoneInputRowRequired r = ( number :: Int
                                   | r
                                   )
...
type PullRequestInputRowRequired r = ( number :: Int
                                     | r
                                     )
...
type RefInputRowRequired r = ( qualifiedName :: String
                             | r
                             )
...
type RefsInputRowRequired r = ( refPrefix :: String
                              | r
                              )
...
type ReleaseInputRowRequired r = ( tagName :: String
                                 | r
                                 )
...
viewerDefaultCommitEmail = selectionForField "viewerDefaultCommitEmail" [] graphqlDefaultResponseScalarDecoder

viewerDefaultMergeMethod :: SelectionSet Scope__Repository PullRequestMergeMethod
viewerDefaultMergeMethod = selectionForField "viewerDefaultMergeMethod" [] graphqlDefaultResponseScalarDecoder
...
viewerPossibleCommitEmails :: SelectionSet Scope__Repository (Maybe (Array String))
viewerPossibleCommitEmails = selectionForField "viewerPossibleCommitEmails" [] graphqlDefaultResponseScalarDecoder
