...
type EmailsInputRowOptional r = ( orderBy :: Optional Examples.Github.InputObject.EnterpriseServerUserAccountEmailOrder
...
enterpriseServerInstallation :: forall r . SelectionSet Scope__EnterpriseServerInstallation r -> SelectionSet Scope__EnterpriseServerUserAccount r
enterpriseServerInstallation = selectionForCompositeField "enterpriseServerInstallation" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
profileName = selectionForField "profileName" [] graphqlDefaultResponseScalarDecoder

remoteCreatedAt :: SelectionSet Scope__EnterpriseServerUserAccount DateTime
remoteCreatedAt = selectionForField "remoteCreatedAt" [] graphqlDefaultResponseScalarDecoder

remoteUserId :: SelectionSet Scope__EnterpriseServerUserAccount Int
remoteUserId = selectionForField "remoteUserId" [] graphqlDefaultResponseScalarDecoder
