...
edges :: forall r . SelectionSet Scope__BranchProtectionRuleEdge r -> SelectionSet Scope__BranchProtectionRuleConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__BranchProtectionRule r -> SelectionSet Scope__BranchProtectionRuleConnection (Array (Maybe r))
