...
edges :: forall r . SelectionSet Scope__SavedReplyEdge r -> SelectionSet Scope__SavedReplyConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__SavedReply r -> SelectionSet Scope__SavedReplyConnection (Array (Maybe r))
