...
maintainer :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__Sponsorship r
maintainer = selectionForCompositeField "maintainer" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

privacyLevel :: SelectionSet Scope__Sponsorship SponsorshipPrivacy
privacyLevel = selectionForField "privacyLevel" [] graphqlDefaultResponseScalarDecoder
...
tier :: forall r . SelectionSet Scope__SponsorsTier r -> SelectionSet Scope__Sponsorship (Maybe r)
tier = selectionForCompositeField "tier" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer
