...
edges :: forall r . SelectionSet Scope__ReleaseAssetEdge r -> SelectionSet Scope__ReleaseAssetConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__ReleaseAsset r -> SelectionSet Scope__ReleaseAssetConnection (Array (Maybe r))
