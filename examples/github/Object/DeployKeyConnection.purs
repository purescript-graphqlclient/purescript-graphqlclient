module Examples.Github.Object.DeployKeyConnection where
...
edges :: forall r . SelectionSet Scope__DeployKeyEdge r -> SelectionSet Scope__DeployKeyConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__DeployKey r -> SelectionSet Scope__DeployKeyConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__DeployKeyConnection r
