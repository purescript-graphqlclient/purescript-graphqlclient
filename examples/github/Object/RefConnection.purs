...
edges :: forall r . SelectionSet Scope__RefEdge r -> SelectionSet Scope__RefConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Ref r -> SelectionSet Scope__RefConnection (Array (Maybe r))
