...
commit :: forall r . SelectionSet Scope__Commit r -> SelectionSet Scope__Deployment (Maybe r)
...
creator :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__Deployment r
...
environment = selectionForField "environment" [] graphqlDefaultResponseScalarDecoder

id :: SelectionSet Scope__Deployment Id
id = selectionForField "id" [] graphqlDefaultResponseScalarDecoder

latestEnvironment :: SelectionSet Scope__Deployment (Maybe String)
latestEnvironment = selectionForField "latestEnvironment" [] graphqlDefaultResponseScalarDecoder

latestStatus :: forall r . SelectionSet Scope__DeploymentStatus r -> SelectionSet Scope__Deployment (Maybe r)
latestStatus = selectionForCompositeField "latestStatus" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

originalEnvironment :: SelectionSet Scope__Deployment (Maybe String)
originalEnvironment = selectionForField "originalEnvironment" [] graphqlDefaultResponseScalarDecoder

payload :: SelectionSet Scope__Deployment (Maybe String)
payload = selectionForField "payload" [] graphqlDefaultResponseScalarDecoder

ref :: forall r . SelectionSet Scope__Ref r -> SelectionSet Scope__Deployment (Maybe r)
ref = selectionForCompositeField "ref" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__Deployment r
