...
edges :: forall r . SelectionSet Scope__ProjectColumnEdge r -> SelectionSet Scope__ProjectColumnConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__ProjectColumn r -> SelectionSet Scope__ProjectColumnConnection (Array (Maybe r))
