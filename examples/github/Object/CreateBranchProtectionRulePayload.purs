...
branchProtectionRule :: forall r . SelectionSet Scope__BranchProtectionRule r -> SelectionSet Scope__CreateBranchProtectionRulePayload (Maybe r)
...
clientMutationId :: SelectionSet Scope__CreateBranchProtectionRulePayload (Maybe String)
