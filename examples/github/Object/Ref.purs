...
repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__Ref r
repository = selectionForCompositeField "repository" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

target :: forall r . SelectionSet Scope__GitObject r -> SelectionSet Scope__Ref (Maybe r)
