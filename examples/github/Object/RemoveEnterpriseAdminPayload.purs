...
admin :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RemoveEnterpriseAdminPayload (Maybe r)
admin = selectionForCompositeField "admin" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

clientMutationId :: SelectionSet Scope__RemoveEnterpriseAdminPayload (Maybe String)
clientMutationId = selectionForField "clientMutationId" [] graphqlDefaultResponseScalarDecoder

enterprise :: forall r . SelectionSet Scope__Enterprise r -> SelectionSet Scope__RemoveEnterpriseAdminPayload (Maybe r)
...
viewer :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__RemoveEnterpriseAdminPayload (Maybe r)
