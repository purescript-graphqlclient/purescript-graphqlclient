...
edges :: forall r . SelectionSet Scope__RepositoryInvitationEdge r -> SelectionSet Scope__RepositoryInvitationConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__RepositoryInvitation r -> SelectionSet Scope__RepositoryInvitationConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__RepositoryInvitationConnection r
