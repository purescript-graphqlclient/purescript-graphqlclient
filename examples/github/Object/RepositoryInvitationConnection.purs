...
edges :: forall r . SelectionSet Scope__RepositoryInvitationEdge r -> SelectionSet Scope__RepositoryInvitationConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__RepositoryInvitation r -> SelectionSet Scope__RepositoryInvitationConnection (Array (Maybe r))
