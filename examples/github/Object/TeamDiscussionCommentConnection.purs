...
edges :: forall r . SelectionSet Scope__TeamDiscussionCommentEdge r -> SelectionSet Scope__TeamDiscussionCommentConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__TeamDiscussionComment r -> SelectionSet Scope__TeamDiscussionCommentConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__TeamDiscussionCommentConnection r
