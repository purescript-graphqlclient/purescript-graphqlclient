...
edges :: forall r . SelectionSet Scope__TeamDiscussionCommentEdge r -> SelectionSet Scope__TeamDiscussionCommentConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__TeamDiscussionComment r -> SelectionSet Scope__TeamDiscussionCommentConnection (Array (Maybe r))
