...
edges :: forall r . SelectionSet Scope__PackageFileEdge r -> SelectionSet Scope__PackageFileConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__PackageFile r -> SelectionSet Scope__PackageFileConnection (Array (Maybe r))
