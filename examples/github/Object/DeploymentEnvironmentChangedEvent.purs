...
actor :: forall r . SelectionSet Scope__Actor r -> SelectionSet Scope__DeploymentEnvironmentChangedEvent (Maybe r)
...
deploymentStatus :: forall r . SelectionSet Scope__DeploymentStatus r -> SelectionSet Scope__DeploymentEnvironmentChangedEvent r
deploymentStatus = selectionForCompositeField "deploymentStatus" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

id :: SelectionSet Scope__DeploymentEnvironmentChangedEvent Id
id = selectionForField "id" [] graphqlDefaultResponseScalarDecoder

pullRequest :: forall r . SelectionSet Scope__PullRequest r -> SelectionSet Scope__DeploymentEnvironmentChangedEvent r
