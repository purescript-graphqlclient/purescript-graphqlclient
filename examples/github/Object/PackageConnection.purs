...
edges :: forall r . SelectionSet Scope__PackageEdge r -> SelectionSet Scope__PackageConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__Package r -> SelectionSet Scope__PackageConnection (Array (Maybe r))
