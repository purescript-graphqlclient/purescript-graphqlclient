...
latestVersion :: forall r . SelectionSet
                            Scope__PackageVersion
                            r -> SelectionSet
                                 Scope__Package
                                 (Maybe
...
statistics :: forall r . SelectionSet
                         Scope__PackageStatistics
                         r -> SelectionSet
                              Scope__Package
                              (Maybe
...
version :: forall r . VersionInput -> SelectionSet
                                      Scope__PackageVersion
                                      r -> SelectionSet
                                           Scope__Package
                                           (Maybe
...
type VersionsInputRowOptional r = ( orderBy :: Optional
...
versions :: forall r . VersionsInput -> SelectionSet
                                        Scope__PackageVersionConnection
                                        r -> SelectionSet
                                             Scope__Package
                                             r
