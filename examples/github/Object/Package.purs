...
latestVersion :: forall r . SelectionSet Scope__PackageVersion r -> SelectionSet Scope__Package (Maybe r)
latestVersion = selectionForCompositeField "latestVersion" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

name :: SelectionSet Scope__Package String
name = selectionForField "name" [] graphqlDefaultResponseScalarDecoder

packageType :: SelectionSet Scope__Package PackageType
packageType = selectionForField "packageType" [] graphqlDefaultResponseScalarDecoder

repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__Package (Maybe r)
...
type VersionInputRowRequired r = ( version :: String
                                 | r
                                 )
...
type VersionsInputRowOptional r = ( orderBy :: Optional Examples.Github.InputObject.PackageVersionOrder
