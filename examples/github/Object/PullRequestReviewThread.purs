...
isResolved = selectionForField "isResolved" [] graphqlDefaultResponseScalarDecoder
...
originalLine = selectionForField "originalLine" [] graphqlDefaultResponseScalarDecoder

originalStartLine :: SelectionSet Scope__PullRequestReviewThread (Maybe Int)
originalStartLine = selectionForField "originalStartLine" [] graphqlDefaultResponseScalarDecoder

pullRequest :: forall r . SelectionSet Scope__PullRequest r -> SelectionSet Scope__PullRequestReviewThread r
pullRequest = selectionForCompositeField "pullRequest" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

repository :: forall r . SelectionSet Scope__Repository r -> SelectionSet Scope__PullRequestReviewThread r
repository = selectionForCompositeField "repository" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

resolvedBy :: forall r . SelectionSet Scope__User r -> SelectionSet Scope__PullRequestReviewThread (Maybe r)
resolvedBy = selectionForCompositeField "resolvedBy" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

startDiffSide :: SelectionSet Scope__PullRequestReviewThread (Maybe DiffSide)
startDiffSide = selectionForField "startDiffSide" [] graphqlDefaultResponseScalarDecoder
...
viewerCanResolve = selectionForField "viewerCanResolve" [] graphqlDefaultResponseScalarDecoder

viewerCanUnresolve :: SelectionSet Scope__PullRequestReviewThread Boolean
viewerCanUnresolve = selectionForField "viewerCanUnresolve" [] graphqlDefaultResponseScalarDecoder
