...
edges :: forall r . SelectionSet Scope__ReviewDismissalAllowanceEdge r -> SelectionSet Scope__ReviewDismissalAllowanceConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__ReviewDismissalAllowance r -> SelectionSet Scope__ReviewDismissalAllowanceConnection (Array (Maybe r))
