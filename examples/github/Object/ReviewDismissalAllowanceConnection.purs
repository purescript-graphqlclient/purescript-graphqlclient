...
edges :: forall r . SelectionSet Scope__ReviewDismissalAllowanceEdge r -> SelectionSet Scope__ReviewDismissalAllowanceConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__ReviewDismissalAllowance r -> SelectionSet Scope__ReviewDismissalAllowanceConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__ReviewDismissalAllowanceConnection r
