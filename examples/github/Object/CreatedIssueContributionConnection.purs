...
edges :: forall r . SelectionSet Scope__CreatedIssueContributionEdge r -> SelectionSet Scope__CreatedIssueContributionConnection (Array (Maybe r))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__CreatedIssueContribution r -> SelectionSet Scope__CreatedIssueContributionConnection (Array (Maybe r))
