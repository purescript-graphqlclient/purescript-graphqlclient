...
edges :: forall r . SelectionSet Scope__CreatedIssueContributionEdge r -> SelectionSet Scope__CreatedIssueContributionConnection (Maybe (Array (Maybe r)))
edges = selectionForCompositeField "edges" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

nodes :: forall r . SelectionSet Scope__CreatedIssueContribution r -> SelectionSet Scope__CreatedIssueContributionConnection (Maybe (Array (Maybe r)))
nodes = selectionForCompositeField "nodes" [] graphqlDefaultResponseFunctorOrScalarDecoderTransformer

pageInfo :: forall r . SelectionSet Scope__PageInfo r -> SelectionSet Scope__CreatedIssueContributionConnection r
