...
derive instance genericEnterpriseAdministratorRole :: Generic EnterpriseAdministratorRole _

instance showEnterpriseAdministratorRole :: Show EnterpriseAdministratorRole where
  show = genericShow
