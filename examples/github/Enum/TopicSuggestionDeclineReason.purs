...
derive instance genericTopicSuggestionDeclineReason :: Generic TopicSuggestionDeclineReason _

instance showTopicSuggestionDeclineReason :: Show TopicSuggestionDeclineReason where
  show = genericShow
