...
derive instance genericRepositoryInteractionLimit :: Generic RepositoryInteractionLimit _
...
instance repositoryInteractionLimitGraphQLDefaultResponseScalarDecoder :: GraphQLDefaultResponseScalarDecoder
                                                                          RepositoryInteractionLimit where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "RepositoryInteractionLimit"
                                        fromToMap

instance repositoryInteractionLimitToGraphQLArgumentValue :: ToGraphQLArgumentValue
                                                             RepositoryInteractionLimit where
