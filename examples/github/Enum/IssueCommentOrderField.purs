module Examples.Github.Enum.IssueCommentOrderField where
...
derive instance genericIssueCommentOrderField :: Generic IssueCommentOrderField _
...
instance issueCommentOrderFieldGraphQLDefaultResponseScalarDecoder :: GraphQLDefaultResponseScalarDecoder
                                                                      IssueCommentOrderField where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "IssueCommentOrderField"
                                        fromToMap

instance issueCommentOrderFieldToGraphQLArgumentValue :: ToGraphQLArgumentValue
                                                         IssueCommentOrderField where
