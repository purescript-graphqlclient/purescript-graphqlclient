...
instance pullRequestTimelineItemsItemTypeGraphQLDefaultResponseScalarDecoder :: GraphQLDefaultResponseScalarDecoder
                                                                                PullRequestTimelineItemsItemType where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "PullRequestTimelineItemsItemType"
                                        fromToMap

instance pullRequestTimelineItemsItemTypeToGraphQLArgumentValue :: ToGraphQLArgumentValue
                                                                   PullRequestTimelineItemsItemType where
