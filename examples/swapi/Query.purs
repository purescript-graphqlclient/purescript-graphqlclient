...
import Examples.Swapi.Scopes (Scope__Droid, Scope__Character, Scope__CharacterUnion, Scope__Human)
...
type GreetInputRowRequired r = ( input :: Examples.Swapi.InputObject.Greeting | r )
