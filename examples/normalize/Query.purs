...
type CircularInputInputRowRequired r = ( input :: Examples.Normalize.InputObject.CircularOne
                                       | r
                                       )

type CircularInputInput = { | CircularInputInputRowRequired + () }

circularInput :: CircularInputInput -> SelectionSet
                                       Scope__RootQuery
                                       (Maybe
                                        String)
...
conflictingTypesUnion :: forall r . SelectionSet
                                    Scope__ConflictingTypesUnion
                                    r -> SelectionSet
                                         Scope__RootQuery
                                         r
...
_droid :: forall r . DroidInput -> SelectionSet
                                   Scope__Droid
                                   r -> SelectionSet
                                        Scope__RootQuery
                                        (Maybe
...
type GreetInputRowRequired r = ( input :: Examples.Normalize.InputObject.Greeting
                               | r
                               )
...
type RecursiveInputInputRowRequired r = ( input :: Examples.Normalize.InputObject.Recursive
                                        | r
                                        )

type RecursiveInputInput = { | RecursiveInputInputRowRequired + () }

recursiveInput :: RecursiveInputInput -> SelectionSet
                                         Scope__RootQuery
                                         (Maybe
                                          String)
...
type TypeInputRowOptional r = ( input :: Optional
                                         Examples.Normalize.InputObject.ReservedWord
                              | r
                              )
