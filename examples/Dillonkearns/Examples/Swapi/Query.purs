module Dillonkearns.Examples.Swapi.Query where

import Dillonkearns.Examples.SwapiCustomScalars (Id, PosixTime)
...
import Dillonkearns.Examples.Swapi.Scopes
  (Scope__Droid, Scope__Character, Scope__CharacterUnion, Scope__Human)
import Data.Maybe (Maybe)
import Dillonkearns.Examples.Swapi.InputObject (Greeting) as Dillonkearns.Examples.Swapi.InputObject
...
type GreetInputRowRequired r
  = ( input :: Dillonkearns.Examples.Swapi.InputObject.Greeting | r )
