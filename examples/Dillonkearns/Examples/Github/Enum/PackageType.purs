module Dillonkearns.Examples.Github.Enum.PackageType where
...
derive instance genericPackageType :: Generic PackageType _

instance showPackageType :: Show PackageType where
  show = genericShow
...
instance packageTypeGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder PackageType where
  graphqlDefaultResponseScalarDecoder = enumDecoder "PackageType" fromToMap

instance packageTypeToGraphQLArgumentValue
  :: ToGraphQLArgumentValue PackageType where
