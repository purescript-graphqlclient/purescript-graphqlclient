module Dillonkearns.Examples.Github.Enum.RepositoryAffiliation where
...
instance repositoryAffiliationGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder RepositoryAffiliation where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "RepositoryAffiliation"
                                        fromToMap

instance repositoryAffiliationToGraphQLArgumentValue
  :: ToGraphQLArgumentValue RepositoryAffiliation where
