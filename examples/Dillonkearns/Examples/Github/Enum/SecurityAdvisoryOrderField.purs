module Dillonkearns.Examples.Github.Enum.SecurityAdvisoryOrderField where
...
derive instance genericSecurityAdvisoryOrderField
  ::
  Generic SecurityAdvisoryOrderField _
...
instance securityAdvisoryOrderFieldGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder SecurityAdvisoryOrderField where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "SecurityAdvisoryOrderField"
                                        fromToMap

instance securityAdvisoryOrderFieldToGraphQLArgumentValue
  :: ToGraphQLArgumentValue SecurityAdvisoryOrderField where
