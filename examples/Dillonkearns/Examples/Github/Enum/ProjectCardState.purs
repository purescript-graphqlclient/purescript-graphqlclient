module Dillonkearns.Examples.Github.Enum.ProjectCardState where
...
instance projectCardStateGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder ProjectCardState where
  graphqlDefaultResponseScalarDecoder = enumDecoder "ProjectCardState" fromToMap

instance projectCardStateToGraphQLArgumentValue
  :: ToGraphQLArgumentValue ProjectCardState where
