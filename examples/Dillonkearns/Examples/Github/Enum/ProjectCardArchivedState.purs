module Dillonkearns.Examples.Github.Enum.ProjectCardArchivedState where
...
derive instance genericProjectCardArchivedState
  ::
  Generic ProjectCardArchivedState _
...
instance projectCardArchivedStateGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder ProjectCardArchivedState where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "ProjectCardArchivedState"
                                        fromToMap

instance projectCardArchivedStateToGraphQLArgumentValue
  :: ToGraphQLArgumentValue ProjectCardArchivedState where
