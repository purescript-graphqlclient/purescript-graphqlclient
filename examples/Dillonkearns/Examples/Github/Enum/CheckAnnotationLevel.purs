module Dillonkearns.Examples.Github.Enum.CheckAnnotationLevel where
...
instance checkAnnotationLevelGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder CheckAnnotationLevel where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "CheckAnnotationLevel"
                                        fromToMap

instance checkAnnotationLevelToGraphQLArgumentValue
  :: ToGraphQLArgumentValue CheckAnnotationLevel where
