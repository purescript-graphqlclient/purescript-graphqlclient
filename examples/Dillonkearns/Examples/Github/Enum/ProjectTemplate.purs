module Dillonkearns.Examples.Github.Enum.ProjectTemplate where
...
instance projectTemplateGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder ProjectTemplate where
  graphqlDefaultResponseScalarDecoder = enumDecoder "ProjectTemplate" fromToMap

instance projectTemplateToGraphQLArgumentValue
  :: ToGraphQLArgumentValue ProjectTemplate where
