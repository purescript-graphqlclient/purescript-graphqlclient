module Dillonkearns.Examples.Github.Enum.IssueTimelineItemsItemType where
...
derive instance genericIssueTimelineItemsItemType
  ::
  Generic IssueTimelineItemsItemType _

instance showIssueTimelineItemsItemType :: Show IssueTimelineItemsItemType where
  show = genericShow
...
instance issueTimelineItemsItemTypeGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder IssueTimelineItemsItemType where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "IssueTimelineItemsItemType"
                                        fromToMap

instance issueTimelineItemsItemTypeToGraphQLArgumentValue
  :: ToGraphQLArgumentValue IssueTimelineItemsItemType where
