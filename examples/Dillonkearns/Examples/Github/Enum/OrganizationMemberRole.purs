module Dillonkearns.Examples.Github.Enum.OrganizationMemberRole where
...
derive instance genericOrganizationMemberRole
  ::
  Generic OrganizationMemberRole _
...
instance organizationMemberRoleGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder OrganizationMemberRole where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "OrganizationMemberRole"
                                        fromToMap

instance organizationMemberRoleToGraphQLArgumentValue
  :: ToGraphQLArgumentValue OrganizationMemberRole where
