module Dillonkearns.Examples.Github.Enum.ProjectOrderField where
...
instance projectOrderFieldGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder ProjectOrderField where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "ProjectOrderField"
                                        fromToMap

instance projectOrderFieldToGraphQLArgumentValue
  :: ToGraphQLArgumentValue ProjectOrderField where
