module Dillonkearns.Examples.Github.Enum.CommentCannotUpdateReason where
...
derive instance genericCommentCannotUpdateReason
  ::
  Generic CommentCannotUpdateReason _
...
instance commentCannotUpdateReasonGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder CommentCannotUpdateReason where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "CommentCannotUpdateReason"
                                        fromToMap

instance commentCannotUpdateReasonToGraphQLArgumentValue
  :: ToGraphQLArgumentValue CommentCannotUpdateReason where
