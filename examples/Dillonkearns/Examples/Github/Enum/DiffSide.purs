module Dillonkearns.Examples.Github.Enum.DiffSide where
...
instance diffSideGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder DiffSide where
