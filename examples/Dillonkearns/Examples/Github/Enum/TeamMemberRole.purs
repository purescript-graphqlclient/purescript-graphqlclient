module Dillonkearns.Examples.Github.Enum.TeamMemberRole where
...
instance teamMemberRoleGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder TeamMemberRole where
  graphqlDefaultResponseScalarDecoder = enumDecoder "TeamMemberRole" fromToMap

instance teamMemberRoleToGraphQLArgumentValue
  :: ToGraphQLArgumentValue TeamMemberRole where
