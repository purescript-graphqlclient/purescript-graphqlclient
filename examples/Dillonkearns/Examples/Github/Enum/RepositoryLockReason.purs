module Dillonkearns.Examples.Github.Enum.RepositoryLockReason where
...
instance repositoryLockReasonGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder RepositoryLockReason where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "RepositoryLockReason"
                                        fromToMap

instance repositoryLockReasonToGraphQLArgumentValue
  :: ToGraphQLArgumentValue RepositoryLockReason where
