module Dillonkearns.Examples.Github.Enum.MergeableState where
...
instance mergeableStateGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder MergeableState where
  graphqlDefaultResponseScalarDecoder = enumDecoder "MergeableState" fromToMap

instance mergeableStateToGraphQLArgumentValue
  :: ToGraphQLArgumentValue MergeableState where
