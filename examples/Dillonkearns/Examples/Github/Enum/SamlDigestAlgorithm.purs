module Dillonkearns.Examples.Github.Enum.SamlDigestAlgorithm where
...
instance samlDigestAlgorithmGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder SamlDigestAlgorithm where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "SamlDigestAlgorithm"
                                        fromToMap

instance samlDigestAlgorithmToGraphQLArgumentValue
  :: ToGraphQLArgumentValue SamlDigestAlgorithm where
