module Dillonkearns.Examples.Github.Enum.ReactionContent where
...
instance reactionContentGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder ReactionContent where
  graphqlDefaultResponseScalarDecoder = enumDecoder "ReactionContent" fromToMap

instance reactionContentToGraphQLArgumentValue
  :: ToGraphQLArgumentValue ReactionContent where
