module Dillonkearns.Examples.Github.Enum.GitSignatureState where
...
instance gitSignatureStateGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder GitSignatureState where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "GitSignatureState"
                                        fromToMap

instance gitSignatureStateToGraphQLArgumentValue
  :: ToGraphQLArgumentValue GitSignatureState where
