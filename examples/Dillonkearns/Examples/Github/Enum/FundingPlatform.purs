module Dillonkearns.Examples.Github.Enum.FundingPlatform where
...
instance fundingPlatformGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder FundingPlatform where
  graphqlDefaultResponseScalarDecoder = enumDecoder "FundingPlatform" fromToMap

instance fundingPlatformToGraphQLArgumentValue
  :: ToGraphQLArgumentValue FundingPlatform where
