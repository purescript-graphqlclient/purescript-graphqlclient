module Dillonkearns.Examples.Github.Enum.PullRequestState where
...
instance pullRequestStateGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder PullRequestState where
  graphqlDefaultResponseScalarDecoder = enumDecoder "PullRequestState" fromToMap

instance pullRequestStateToGraphQLArgumentValue
  :: ToGraphQLArgumentValue PullRequestState where
