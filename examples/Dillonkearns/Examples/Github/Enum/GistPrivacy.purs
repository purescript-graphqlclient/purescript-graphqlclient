module Dillonkearns.Examples.Github.Enum.GistPrivacy where
...
instance gistPrivacyGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder GistPrivacy where
  graphqlDefaultResponseScalarDecoder = enumDecoder "GistPrivacy" fromToMap

instance gistPrivacyToGraphQLArgumentValue
  :: ToGraphQLArgumentValue GistPrivacy where
