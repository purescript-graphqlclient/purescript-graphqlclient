module Dillonkearns.Examples.Github.Enum.UserBlockDuration where
...
instance userBlockDurationGraphQLDefaultResponseScalarDecoder
  :: GraphQLDefaultResponseScalarDecoder UserBlockDuration where
  graphqlDefaultResponseScalarDecoder = enumDecoder
                                        "UserBlockDuration"
                                        fromToMap

instance userBlockDurationToGraphQLArgumentValue
  :: ToGraphQLArgumentValue UserBlockDuration where
