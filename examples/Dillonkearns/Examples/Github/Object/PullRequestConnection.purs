module Dillonkearns.Examples.Github.Object.PullRequestConnection where
...
edges
  :: forall r
   . SelectionSet Scope__PullRequestEdge r
  -> SelectionSet Scope__PullRequestConnection (Maybe (Array (Maybe r)))
