module Dillonkearns.Examples.Github.Object.PackageVersionConnection where
...
edges
  :: forall r
   . SelectionSet Scope__PackageVersionEdge r
  -> SelectionSet Scope__PackageVersionConnection (Maybe (Array (Maybe r)))
