module Dillonkearns.Examples.Github.Object.Gist where
...
import Dillonkearns.Examples.Github.Scalars (DateTime, GitObjectId, Id, Uri)
import Data.Maybe (Maybe)
import Dillonkearns.Examples.Github.InputObject (GistOrder, StarOrder) as Dillonkearns.Examples.Github.InputObject
...
type FilesInputRowOptional r
  = ( limit :: Optional Int, oid :: Optional GitObjectId | r )
...
files
  :: forall r
   . FilesInput
  -> SelectionSet Scope__GistFile r
  -> SelectionSet Scope__Gist (Maybe (Array (Maybe r)))
...
owner
  ...
  -> SelectionSet Scope__Gist (Maybe r)
