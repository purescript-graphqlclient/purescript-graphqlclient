module Dillonkearns.Examples.Github.Object.PullRequestReview where
...
author
  ...
  -> SelectionSet Scope__PullRequestReview (Maybe r)
...
type OnBehalfOfInputRowOptional r
  = ( after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
...
reactionGroups
  ...
  -> SelectionSet Scope__PullRequestReview (Maybe (Array r))
