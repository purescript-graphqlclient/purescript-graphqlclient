module Dillonkearns.Examples.Github.Object.User where
...
import Dillonkearns.Examples.Github.Scalars (Uri, Html, Id, DateTime)
import Data.Maybe (Maybe)
import Dillonkearns.Examples.Github.Enum.GistPrivacy (GistPrivacy)
...
import Dillonkearns.Examples.Github.Enum.RepositoryContributionType
...
type GistsInputRowOptional r
  = ( privacy :: Optional GistPrivacy
    , orderBy :: Optional Dillonkearns.Examples.Github.InputObject.GistOrder
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
...
type IssueCommentsInputRowOptional r
  = ( orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.IssueCommentOrder
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
...
type SavedRepliesInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.SavedReplyOrder
    | r
    )
...
type TopRepositoriesInputRowRequired r
  = ( orderBy :: Dillonkearns.Examples.Github.InputObject.RepositoryOrder | r )
