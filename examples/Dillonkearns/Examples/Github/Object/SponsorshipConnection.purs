module Dillonkearns.Examples.Github.Object.SponsorshipConnection where
...
edges
  :: forall r
   . SelectionSet Scope__SponsorshipEdge r
  -> SelectionSet Scope__SponsorshipConnection (Maybe (Array (Maybe r)))
