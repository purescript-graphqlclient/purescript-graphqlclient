module Dillonkearns.Examples.Github.Object.OrgUpdateMemberRepositoryCreationPermissionAuditEntry where
...
import Dillonkearns.Examples.Github.Enum.OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility
...
canCreateRepositories
  :: SelectionSet
     Scope__OrgUpdateMemberRepositoryCreationPermissionAuditEntry
     (Maybe Boolean)
canCreateRepositories = selectionForField
                        "canCreateRepositories"
                        []
                        graphqlDefaultResponseScalarDecoder
...
visibility
  :: SelectionSet
     Scope__OrgUpdateMemberRepositoryCreationPermissionAuditEntry
     (Maybe OrgUpdateMemberRepositoryCreationPermissionAuditEntryVisibility)
