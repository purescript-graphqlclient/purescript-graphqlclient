module Dillonkearns.Examples.Github.Object.UserStatusConnection where
...
edges
  :: forall r
   . SelectionSet Scope__UserStatusEdge r
  -> SelectionSet Scope__UserStatusConnection (Maybe (Array (Maybe r)))
