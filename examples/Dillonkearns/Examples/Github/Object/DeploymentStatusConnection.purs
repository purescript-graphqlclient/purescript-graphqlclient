module Dillonkearns.Examples.Github.Object.DeploymentStatusConnection where
...
edges
  :: forall r
   . SelectionSet Scope__DeploymentStatusEdge r
  -> SelectionSet Scope__DeploymentStatusConnection (Maybe (Array (Maybe r)))
