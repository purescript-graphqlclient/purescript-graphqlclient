module Dillonkearns.Examples.Github.Object.OrganizationConnection where
...
edges
  :: forall r
   . SelectionSet Scope__OrganizationEdge r
  -> SelectionSet Scope__OrganizationConnection (Maybe (Array (Maybe r)))
