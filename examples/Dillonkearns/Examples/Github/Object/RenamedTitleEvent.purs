module Dillonkearns.Examples.Github.Object.RenamedTitleEvent where
...
import Dillonkearns.Examples.Github.Scopes
  (Scope__Actor, Scope__RenamedTitleEvent, Scope__RenamedTitleSubject)
...
actor
  ...
  -> SelectionSet Scope__RenamedTitleEvent (Maybe r)
...
currentTitle = selectionForField
               "currentTitle"
               []
               graphqlDefaultResponseScalarDecoder
...
previousTitle = selectionForField
                "previousTitle"
                []
                graphqlDefaultResponseScalarDecoder
...
subject
  :: forall r
   . SelectionSet Scope__RenamedTitleSubject r
  -> SelectionSet Scope__RenamedTitleEvent r
