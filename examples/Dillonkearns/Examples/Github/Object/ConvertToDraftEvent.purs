module Dillonkearns.Examples.Github.Object.ConvertToDraftEvent where
...
actor
  ...
  -> SelectionSet Scope__ConvertToDraftEvent (Maybe r)
...
pullRequest
  ...
  -> SelectionSet Scope__ConvertToDraftEvent r
