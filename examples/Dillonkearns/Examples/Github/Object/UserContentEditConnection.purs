module Dillonkearns.Examples.Github.Object.UserContentEditConnection where
...
edges
  :: forall r
   . SelectionSet Scope__UserContentEditEdge r
  -> SelectionSet Scope__UserContentEditConnection (Maybe (Array (Maybe r)))
