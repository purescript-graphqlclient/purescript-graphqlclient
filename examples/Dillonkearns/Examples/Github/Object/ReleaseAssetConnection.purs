module Dillonkearns.Examples.Github.Object.ReleaseAssetConnection where
...
edges
  :: forall r
   . SelectionSet Scope__ReleaseAssetEdge r
  -> SelectionSet Scope__ReleaseAssetConnection (Maybe (Array (Maybe r)))
