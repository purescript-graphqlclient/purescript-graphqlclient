module Dillonkearns.Examples.Github.Object.ReviewRequestConnection where
...
edges
  :: forall r
   . SelectionSet Scope__ReviewRequestEdge r
  -> SelectionSet Scope__ReviewRequestConnection (Maybe (Array (Maybe r)))
