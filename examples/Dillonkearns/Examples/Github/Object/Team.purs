module Dillonkearns.Examples.Github.Object.Team where
...
import Dillonkearns.Examples.Github.Enum.TeamMembershipType (TeamMembershipType)
...
type DiscussionsInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.TeamDiscussionOrder
    | r
    )
...
type MembersInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.TeamMemberOrder
    | r
    )
...
type RepositoriesInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.TeamRepositoryOrder
    | r
    )
