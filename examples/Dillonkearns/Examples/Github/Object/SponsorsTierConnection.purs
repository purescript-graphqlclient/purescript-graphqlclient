module Dillonkearns.Examples.Github.Object.SponsorsTierConnection where
...
edges
  :: forall r
   . SelectionSet Scope__SponsorsTierEdge r
  -> SelectionSet Scope__SponsorsTierConnection (Maybe (Array (Maybe r)))
