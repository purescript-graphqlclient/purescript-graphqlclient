module Dillonkearns.Examples.Github.Object.SubmoduleConnection where
...
edges
  :: forall r
   . SelectionSet Scope__SubmoduleEdge r
  -> SelectionSet Scope__SubmoduleConnection (Maybe (Array (Maybe r)))
