module Dillonkearns.Examples.Github.Object.Commit where
...
import Dillonkearns.Examples.Github.InputObject
  (PullRequestOrder, CheckSuiteFilter, DeploymentOrder, CommitAuthor) as Dillonkearns.Examples.Github.InputObject
...
type AssociatedPullRequestsInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.PullRequestOrder
    | r
    )
...
type CheckSuitesInputRowOptional r
  = ( after :: Optional String
    ...
    , filterBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.CheckSuiteFilter
    | r
    )
...
type HistoryInputRowOptional r
  = ( after :: Optional String
    ...
    , author :: Optional Dillonkearns.Examples.Github.InputObject.CommitAuthor
