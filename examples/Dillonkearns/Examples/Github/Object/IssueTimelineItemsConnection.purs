module Dillonkearns.Examples.Github.Object.IssueTimelineItemsConnection where
...
edges
  :: forall r
   . SelectionSet Scope__IssueTimelineItemsEdge r
  -> SelectionSet Scope__IssueTimelineItemsConnection (Maybe (Array (Maybe r)))
