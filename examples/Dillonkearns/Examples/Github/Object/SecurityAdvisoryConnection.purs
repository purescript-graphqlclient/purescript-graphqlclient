module Dillonkearns.Examples.Github.Object.SecurityAdvisoryConnection where
...
edges
  :: forall r
   . SelectionSet Scope__SecurityAdvisoryEdge r
  -> SelectionSet Scope__SecurityAdvisoryConnection (Maybe (Array (Maybe r)))
