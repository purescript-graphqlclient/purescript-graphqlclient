module Dillonkearns.Examples.Github.Object.PackageFile where
...
import Dillonkearns.Examples.Github.Scopes
  (Scope__PackageFile, Scope__PackageVersion)
import Dillonkearns.Examples.Github.Scalars (Id, DateTime, Uri)
...
packageVersion
  ...
  -> SelectionSet Scope__PackageFile (Maybe r)
packageVersion = selectionForCompositeField
                 "packageVersion"
                 []
                 graphqlDefaultResponseFunctorOrScalarDecoderTransformer
