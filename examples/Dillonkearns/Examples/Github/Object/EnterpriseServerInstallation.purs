module Dillonkearns.Examples.Github.Object.EnterpriseServerInstallation where
...
import Dillonkearns.Examples.Github.InputObject
  (EnterpriseServerUserAccountOrder, EnterpriseServerUserAccountsUploadOrder) as Dillonkearns.Examples.Github.InputObject
...
type UserAccountsInputRowOptional r
  = ( orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.EnterpriseServerUserAccountOrder
...
type UserAccountsUploadsInputRowOptional r
  = ( orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.EnterpriseServerUserAccountsUploadOrder
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
