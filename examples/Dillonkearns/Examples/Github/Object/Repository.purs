module Dillonkearns.Examples.Github.Object.Repository where
...
import Dillonkearns.Examples.Github.Enum.CollaboratorAffiliation
  (CollaboratorAffiliation)
import Dillonkearns.Examples.Github.Scalars
...
import Dillonkearns.Examples.Github.Enum.RepositoryPrivacy (RepositoryPrivacy)
import Dillonkearns.Examples.Github.Enum.RepositoryAffiliation
  (RepositoryAffiliation)
import Dillonkearns.Examples.Github.Enum.IssueState (IssueState)
import Dillonkearns.Examples.Github.Enum.RepositoryLockReason
...
branchProtectionRules
  ...
  -> SelectionSet Scope__BranchProtectionRuleConnection r
  -> SelectionSet Scope__Repository r
...
type CollaboratorsInputRowOptional r
  = ( affiliation :: Optional CollaboratorAffiliation
    , query :: Optional String
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
...
collaborators
  :: forall r
   . CollaboratorsInput
  -> SelectionSet Scope__RepositoryCollaboratorConnection r
  -> SelectionSet Scope__Repository (Maybe r)
...
contactLinks
  :: forall r
   . SelectionSet Scope__RepositoryContactLink r
...
type DeployKeysInputRowOptional r
  = ( after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
...
type DeploymentsInputRowOptional r
  = ( environments :: Optional (Array String)
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.DeploymentOrder
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
...
fundingLinks
  :: forall r
   . SelectionSet Scope__FundingLink r
  -> SelectionSet Scope__Repository (Array r)
...
issueTemplates
  :: forall r
   . SelectionSet Scope__IssueTemplate r
  -> SelectionSet Scope__Repository (Maybe (Array r))
...
type LabelsInputRowOptional r
  = ( orderBy :: Optional Dillonkearns.Examples.Github.InputObject.LabelOrder
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
...
type LanguagesInputRowOptional r
  = ( after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
    , orderBy :: Optional Dillonkearns.Examples.Github.InputObject.LanguageOrder
    | r
    )
...
latestRelease
  ...
  -> SelectionSet Scope__Repository (Maybe r)
latestRelease = selectionForCompositeField
                "latestRelease"
                []
                graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
type MentionableUsersInputRowOptional r
  = ( query :: Optional String
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
...
type MilestonesInputRowOptional r
  = ( after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.MilestoneOrder
    , query :: Optional String
    | r
    )
...
milestones
  :: forall r
   . MilestonesInput
  -> SelectionSet Scope__MilestoneConnection r
  -> SelectionSet Scope__Repository (Maybe r)
...
type ObjectInputRowOptional r
  = ( oid :: Optional GitObjectId, expression :: Optional String | r )
...
object
  :: forall r
   . ObjectInput
  -> SelectionSet Scope__GitObject r
  -> SelectionSet Scope__Repository (Maybe r)
...
type PackagesInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy :: Optional Dillonkearns.Examples.Github.InputObject.PackageOrder
    | r
    )
...
type RefsInputRowOptional r
  = ( query :: Optional String
    ...
    , orderBy :: Optional Dillonkearns.Examples.Github.InputObject.RefOrder
    | r
    )
...
type ReleasesInputRowOptional r
  = ( after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
    , orderBy :: Optional Dillonkearns.Examples.Github.InputObject.ReleaseOrder
    | r
    )
...
type RepositoryTopicsInputRowOptional r
  = ( after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
...
repositoryTopics
  :: forall r
   . RepositoryTopicsInput
  -> SelectionSet Scope__RepositoryTopicConnection r
  -> SelectionSet Scope__Repository r
...
shortDescriptionHTML
  ...
  -> SelectionSet Scope__Repository Html
...
type StargazersInputRowOptional r
  = ( after :: Optional String
    ...
    , first :: Optional Int
    , last :: Optional Int
    , orderBy :: Optional Dillonkearns.Examples.Github.InputObject.StarOrder
    | r
    )
...
vulnerabilityAlerts
  ...
  -> SelectionSet Scope__RepositoryVulnerabilityAlertConnection r
  -> SelectionSet Scope__Repository (Maybe r)
...
type WatchersInputRowOptional r
  = ( after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
