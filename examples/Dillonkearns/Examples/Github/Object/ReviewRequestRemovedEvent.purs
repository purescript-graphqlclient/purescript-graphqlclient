module Dillonkearns.Examples.Github.Object.ReviewRequestRemovedEvent where
...
actor
  ...
  -> SelectionSet Scope__ReviewRequestRemovedEvent (Maybe r)
...
pullRequest
  ...
  -> SelectionSet Scope__ReviewRequestRemovedEvent r
