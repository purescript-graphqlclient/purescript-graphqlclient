module Dillonkearns.Examples.Github.Object.IpAllowListEntryConnection where
...
edges
  :: forall r
   . SelectionSet Scope__IpAllowListEntryEdge r
  -> SelectionSet Scope__IpAllowListEntryConnection (Maybe (Array (Maybe r)))
