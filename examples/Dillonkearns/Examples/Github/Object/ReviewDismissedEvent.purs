module Dillonkearns.Examples.Github.Object.ReviewDismissedEvent where
...
actor
  ...
  -> SelectionSet Scope__ReviewDismissedEvent (Maybe r)
...
previousReviewState
  :: SelectionSet
     Scope__ReviewDismissedEvent
     PullRequestReviewState
previousReviewState = selectionForField
                      "previousReviewState"
                      []
                      graphqlDefaultResponseScalarDecoder
...
pullRequest
  ...
  -> SelectionSet Scope__ReviewDismissedEvent r
...
pullRequestCommit
  ...
  -> SelectionSet Scope__ReviewDismissedEvent (Maybe r)
pullRequestCommit = selectionForCompositeField
                    "pullRequestCommit"
                    []
                    graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
review
  ...
  -> SelectionSet Scope__ReviewDismissedEvent (Maybe r)
review = selectionForCompositeField
         "review"
         []
         graphqlDefaultResponseFunctorOrScalarDecoderTransformer
