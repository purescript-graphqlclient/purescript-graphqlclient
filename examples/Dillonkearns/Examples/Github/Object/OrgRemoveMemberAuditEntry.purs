module Dillonkearns.Examples.Github.Object.OrgRemoveMemberAuditEntry where
...
import Dillonkearns.Examples.Github.Enum.OrgRemoveMemberAuditEntryMembershipType
  (OrgRemoveMemberAuditEntryMembershipType)
import Dillonkearns.Examples.Github.Enum.OperationType (OperationType)
import Dillonkearns.Examples.Github.Enum.OrgRemoveMemberAuditEntryReason
...
actor
  ...
  -> SelectionSet Scope__OrgRemoveMemberAuditEntry (Maybe r)
...
membershipTypes
  :: SelectionSet
     Scope__OrgRemoveMemberAuditEntry
     (Maybe (Array OrgRemoveMemberAuditEntryMembershipType))
...
reason
  :: SelectionSet
     Scope__OrgRemoveMemberAuditEntry
     (Maybe OrgRemoveMemberAuditEntryReason)
