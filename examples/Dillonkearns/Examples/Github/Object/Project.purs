module Dillonkearns.Examples.Github.Object.Project where
...
type ColumnsInputRowOptional r
...
columns
  :: forall r
   . ColumnsInput
  -> SelectionSet Scope__ProjectColumnConnection r
...
creator
  ...
  -> SelectionSet Scope__Project (Maybe r)
...
type PendingCardsInputRowOptional r
  = ( after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
...
progress
  :: forall r
   . SelectionSet Scope__ProjectProgress r
  -> SelectionSet Scope__Project r
