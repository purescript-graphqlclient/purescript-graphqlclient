module Dillonkearns.Examples.Github.Object.CrossReferencedEvent where
...
actor
  ...
  -> SelectionSet Scope__CrossReferencedEvent (Maybe r)
...
source
  ...
  -> SelectionSet Scope__CrossReferencedEvent r
