module Dillonkearns.Examples.Github.Object.MarketplaceListingConnection where
...
edges
  :: forall r
   . SelectionSet Scope__MarketplaceListingEdge r
  -> SelectionSet Scope__MarketplaceListingConnection (Maybe (Array (Maybe r)))
