module Dillonkearns.Examples.Github.Object.AutomaticBaseChangeFailedEvent where
...
actor
  ...
  -> SelectionSet Scope__AutomaticBaseChangeFailedEvent (Maybe r)
...
pullRequest
  ...
  -> SelectionSet Scope__AutomaticBaseChangeFailedEvent r
