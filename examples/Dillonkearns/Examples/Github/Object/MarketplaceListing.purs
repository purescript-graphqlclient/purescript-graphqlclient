module Dillonkearns.Examples.Github.Object.MarketplaceListing where
...
import Dillonkearns.Examples.Github.Scalars (Uri, Html, Id)
import Type.Row (type (+))

app
  :: forall r
   . SelectionSet Scope__App r
  -> SelectionSet Scope__MarketplaceListing (Maybe r)
