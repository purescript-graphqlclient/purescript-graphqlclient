module Dillonkearns.Examples.Github.Object.ReactionConnection where
...
edges
  :: forall r
   . SelectionSet Scope__ReactionEdge r
  -> SelectionSet Scope__ReactionConnection (Maybe (Array (Maybe r)))
