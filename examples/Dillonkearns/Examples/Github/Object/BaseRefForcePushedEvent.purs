module Dillonkearns.Examples.Github.Object.BaseRefForcePushedEvent where
...
actor
  ...
  -> SelectionSet Scope__BaseRefForcePushedEvent (Maybe r)
...
afterCommit
  ...
  -> SelectionSet Scope__BaseRefForcePushedEvent (Maybe r)
afterCommit = selectionForCompositeField
              "afterCommit"
              []
              graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
beforeCommit
  :: forall r
   . SelectionSet Scope__Commit r
  -> SelectionSet Scope__BaseRefForcePushedEvent (Maybe r)
beforeCommit = selectionForCompositeField
               "beforeCommit"
               []
               graphqlDefaultResponseFunctorOrScalarDecoderTransformer
...
pullRequest
  ...
  -> SelectionSet Scope__BaseRefForcePushedEvent r
