module Dillonkearns.Examples.Github.Object.PullRequestReviewComment where
...
import Dillonkearns.Examples.Github.Enum.PullRequestReviewCommentState
...
author
  ...
  -> SelectionSet Scope__PullRequestReviewComment (Maybe r)
...
originalCommit
  :: forall r
   . SelectionSet Scope__Commit r
  -> SelectionSet Scope__PullRequestReviewComment (Maybe r)
originalCommit = selectionForCompositeField
                 "originalCommit"
                 []
                 graphqlDefaultResponseFunctorOrScalarDecoderTransformer

originalPosition :: SelectionSet Scope__PullRequestReviewComment Int
originalPosition = selectionForField
                   "originalPosition"
                   []
                   graphqlDefaultResponseScalarDecoder
...
reactionGroups
  ...
  -> SelectionSet Scope__PullRequestReviewComment (Maybe (Array r))
