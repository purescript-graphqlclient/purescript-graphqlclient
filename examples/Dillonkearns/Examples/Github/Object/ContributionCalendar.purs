module Dillonkearns.Examples.Github.Object.ContributionCalendar where
...
months
  :: forall r
   . SelectionSet Scope__ContributionCalendarMonth r
  -> SelectionSet Scope__ContributionCalendar (Array r)
months = selectionForCompositeField
         "months"
         []
         graphqlDefaultResponseFunctorOrScalarDecoderTransformer

totalContributions :: SelectionSet Scope__ContributionCalendar Int
totalContributions = selectionForField
                     "totalContributions"
                     []
                     graphqlDefaultResponseScalarDecoder
...
weeks
  :: forall r
   . SelectionSet Scope__ContributionCalendarWeek r
  -> SelectionSet Scope__ContributionCalendar (Array r)
weeks = selectionForCompositeField
        "weeks"
        []
        graphqlDefaultResponseFunctorOrScalarDecoderTransformer
