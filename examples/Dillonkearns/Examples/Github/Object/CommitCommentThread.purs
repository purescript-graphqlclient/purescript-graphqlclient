module Dillonkearns.Examples.Github.Object.CommitCommentThread where
...
comments
  ...
  -> SelectionSet Scope__CommitCommentThread r
...
commit
  ...
  -> SelectionSet Scope__CommitCommentThread (Maybe r)
