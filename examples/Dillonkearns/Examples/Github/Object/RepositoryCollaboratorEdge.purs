module Dillonkearns.Examples.Github.Object.RepositoryCollaboratorEdge where
...
node
  ...
  -> SelectionSet Scope__RepositoryCollaboratorEdge r
...
permissionSources
  ...
  -> SelectionSet Scope__RepositoryCollaboratorEdge (Maybe (Array r))
permissionSources = selectionForCompositeField
                    "permissionSources"
                    []
                    graphqlDefaultResponseFunctorOrScalarDecoderTransformer
