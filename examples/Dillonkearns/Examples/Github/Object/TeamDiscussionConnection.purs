module Dillonkearns.Examples.Github.Object.TeamDiscussionConnection where
...
edges
  :: forall r
   . SelectionSet Scope__TeamDiscussionEdge r
  -> SelectionSet Scope__TeamDiscussionConnection (Maybe (Array (Maybe r)))
