module Dillonkearns.Examples.Github.Object.GpgSignature where
...
import Dillonkearns.Examples.Github.Scopes (Scope__GpgSignature, Scope__User)
...
signer
  ...
  -> SelectionSet Scope__GpgSignature (Maybe r)
