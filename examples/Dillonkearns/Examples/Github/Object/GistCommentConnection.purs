module Dillonkearns.Examples.Github.Object.GistCommentConnection where
...
edges
  :: forall r
   . SelectionSet Scope__GistCommentEdge r
  -> SelectionSet Scope__GistCommentConnection (Maybe (Array (Maybe r)))
