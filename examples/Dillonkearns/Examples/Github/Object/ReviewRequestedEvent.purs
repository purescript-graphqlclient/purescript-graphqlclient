module Dillonkearns.Examples.Github.Object.ReviewRequestedEvent where
...
actor
  ...
  -> SelectionSet Scope__ReviewRequestedEvent (Maybe r)
...
pullRequest
  ...
  -> SelectionSet Scope__ReviewRequestedEvent r
