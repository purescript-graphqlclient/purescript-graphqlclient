module Dillonkearns.Examples.Github.Object.OrgDisableSamlAuditEntry where
...
actor
  ...
  -> SelectionSet Scope__OrgDisableSamlAuditEntry (Maybe r)
...
digestMethodUrl = selectionForField
                  "digestMethodUrl"
                  []
                  graphqlDefaultResponseScalarDecoder
