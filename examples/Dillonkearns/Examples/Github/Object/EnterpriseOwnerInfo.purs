module Dillonkearns.Examples.Github.Object.EnterpriseOwnerInfo where
...
import Dillonkearns.Examples.Github.Enum.OrganizationMembersCanCreateRepositoriesSettingValue
...
import Dillonkearns.Examples.Github.Enum.IdentityProviderConfigurationState
...
type AdminsInputRowOptional r
  = ( query :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.EnterpriseMemberOrder
...
type AllowPrivateRepositoryForkingSettingOrganizationsInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.OrganizationOrder
    | r
    )
...
type DomainsInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.VerifiableDomainOrder
    | r
    )
...
type EnterpriseServerInstallationsInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.EnterpriseServerInstallationOrder
    | r
    )
...
type IpAllowListEntriesInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.IpAllowListEntryOrder
    | r
    )
...
type PendingAdminInvitationsInputRowOptional r
  = ( query :: Optional String
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.EnterpriseAdministratorInvitationOrder
    , role :: Optional EnterpriseAdministratorRole
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
...
type PendingCollaboratorInvitationsInputRowOptional r
  = ( query :: Optional String
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.RepositoryInvitationOrder
    , after :: Optional String
    , before :: Optional String
    , first :: Optional Int
    , last :: Optional Int
