module Dillonkearns.Examples.Github.Object.OrgRestoreMemberAuditEntry where
...
actor
  ...
  -> SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe r)
...
restoredMemberships
  :: forall r
   . SelectionSet Scope__OrgRestoreMemberAuditEntryMembership r
  -> SelectionSet Scope__OrgRestoreMemberAuditEntry (Maybe (Array r))
