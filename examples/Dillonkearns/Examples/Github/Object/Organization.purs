module Dillonkearns.Examples.Github.Object.Organization where
...
import Dillonkearns.Examples.Github.Enum.PinnableItemType (PinnableItemType)
...
import Dillonkearns.Examples.Github.Enum.TeamPrivacy (TeamPrivacy)
import Dillonkearns.Examples.Github.Enum.TeamRole (TeamRole)
...
type AuditLogInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy :: Optional Dillonkearns.Examples.Github.InputObject.AuditLogOrder
    | r
    )
...
type MemberStatusesInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.UserStatusOrder
    | r
    )
...
type TeamsInputRowOptional r
  = ( privacy :: Optional TeamPrivacy
    ...
    , orderBy :: Optional Dillonkearns.Examples.Github.InputObject.TeamOrder
