module Dillonkearns.Examples.Github.Object.CommitCommentConnection where
...
edges
  :: forall r
   . SelectionSet Scope__CommitCommentEdge r
  -> SelectionSet Scope__CommitCommentConnection (Maybe (Array (Maybe r)))
