module Dillonkearns.Examples.Github.Object.EnterpriseMemberConnection where
...
edges
  :: forall r
   . SelectionSet Scope__EnterpriseMemberEdge r
  -> SelectionSet Scope__EnterpriseMemberConnection (Maybe (Array (Maybe r)))
