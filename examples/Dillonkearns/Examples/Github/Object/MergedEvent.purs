module Dillonkearns.Examples.Github.Object.MergedEvent where
...
actor
  ...
  -> SelectionSet Scope__MergedEvent (Maybe r)
...
mergeRef
  ...
  -> SelectionSet Scope__MergedEvent (Maybe r)
mergeRef = selectionForCompositeField
           "mergeRef"
           []
           graphqlDefaultResponseFunctorOrScalarDecoderTransformer

mergeRefName :: SelectionSet Scope__MergedEvent String
mergeRefName = selectionForField
               "mergeRefName"
               []
               graphqlDefaultResponseScalarDecoder
...
pullRequest
  ...
  -> SelectionSet Scope__MergedEvent r
