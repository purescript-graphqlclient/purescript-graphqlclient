module Dillonkearns.Examples.Github.Object.EnterpriseIdentityProvider where
...
import Dillonkearns.Examples.Github.Scalars (Id, X509Certificate, Uri)
...
enterprise
  ...
  -> SelectionSet Scope__EnterpriseIdentityProvider (Maybe r)
