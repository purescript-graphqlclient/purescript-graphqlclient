module Dillonkearns.Examples.Github.Object.DisconnectedEvent where
...
actor
  ...
  -> SelectionSet Scope__DisconnectedEvent (Maybe r)
...
source
  ...
  -> SelectionSet Scope__DisconnectedEvent r
