module Dillonkearns.Examples.Github.InputObject where

import Dillonkearns.Examples.Github.Scalars (Id, GitObjectId, Uri, DateTime)
import Dillonkearns.GraphQLClient
  (Optional, class ToGraphQLArgumentValue, toGraphQLArgumentValue)
import Data.Generic.Rep (class Generic)
import Data.Newtype (class Newtype)
import Dillonkearns.Examples.Github.Enum.PullRequestReviewEvent
  (PullRequestReviewEvent)
import Data.Maybe (Maybe)
import Dillonkearns.Examples.Github.Enum.DiffSide (DiffSide)
import Dillonkearns.Examples.Github.Enum.ReactionContent (ReactionContent)
import Dillonkearns.Examples.Github.Enum.AuditLogOrderField (AuditLogOrderField)
import Dillonkearns.Examples.Github.Enum.OrderDirection (OrderDirection)
import Dillonkearns.Examples.Github.Enum.CheckAnnotationLevel
  (CheckAnnotationLevel)
import Dillonkearns.Examples.Github.Enum.CheckRunType (CheckRunType)
import Dillonkearns.Examples.Github.Enum.CheckStatusState (CheckStatusState)
import Dillonkearns.Examples.Github.Enum.RepositoryVisibility
  (RepositoryVisibility)
import Dillonkearns.Examples.Github.Enum.CommitContributionOrderField
  (CommitContributionOrderField)
import Dillonkearns.Examples.Github.Enum.RequestableCheckStatusState
  (RequestableCheckStatusState)
import Dillonkearns.Examples.Github.Enum.CheckConclusionState
  (CheckConclusionState)
import Dillonkearns.Examples.Github.Enum.ProjectTemplate (ProjectTemplate)
import Dillonkearns.Examples.Github.Enum.TopicSuggestionDeclineReason
  (TopicSuggestionDeclineReason)
import Dillonkearns.Examples.Github.Enum.DeploymentOrderField
  (DeploymentOrderField)
import Dillonkearns.Examples.Github.Enum.PullRequestMergeMethod
  (PullRequestMergeMethod)
import Dillonkearns.Examples.Github.Enum.EnterpriseAdministratorInvitationOrderField
  (EnterpriseAdministratorInvitationOrderField)
import Dillonkearns.Examples.Github.Enum.EnterpriseMemberOrderField
  (EnterpriseMemberOrderField)
import Dillonkearns.Examples.Github.Enum.EnterpriseServerInstallationOrderField
  (EnterpriseServerInstallationOrderField)
import Dillonkearns.Examples.Github.Enum.EnterpriseServerUserAccountEmailOrderField
  (EnterpriseServerUserAccountEmailOrderField)
import Dillonkearns.Examples.Github.Enum.EnterpriseServerUserAccountOrderField
  (EnterpriseServerUserAccountOrderField)
import Dillonkearns.Examples.Github.Enum.EnterpriseServerUserAccountsUploadOrderField
  (EnterpriseServerUserAccountsUploadOrderField)
import Dillonkearns.Examples.Github.Enum.GistOrderField (GistOrderField)
import Dillonkearns.Examples.Github.Enum.EnterpriseAdministratorRole
  (EnterpriseAdministratorRole)
import Dillonkearns.Examples.Github.Enum.IpAllowListEntryOrderField
  (IpAllowListEntryOrderField)
import Dillonkearns.Examples.Github.Enum.IssueCommentOrderField
  (IssueCommentOrderField)
import Dillonkearns.Examples.Github.Enum.IssueState (IssueState)
import Dillonkearns.Examples.Github.Enum.IssueOrderField (IssueOrderField)
import Dillonkearns.Examples.Github.Enum.LabelOrderField (LabelOrderField)
import Dillonkearns.Examples.Github.Enum.LanguageOrderField (LanguageOrderField)
import Dillonkearns.Examples.Github.Enum.LockReason (LockReason)
import Dillonkearns.Examples.Github.Enum.MilestoneOrderField
  (MilestoneOrderField)
import Dillonkearns.Examples.Github.Enum.ReportedContentClassifiers
  (ReportedContentClassifiers)
import Dillonkearns.Examples.Github.Enum.OrganizationOrderField
  (OrganizationOrderField)
import Dillonkearns.Examples.Github.Enum.PackageFileOrderField
  (PackageFileOrderField)
import Dillonkearns.Examples.Github.Enum.PackageOrderField (PackageOrderField)
import Dillonkearns.Examples.Github.Enum.PackageVersionOrderField
  (PackageVersionOrderField)
import Dillonkearns.Examples.Github.Enum.ProjectOrderField (ProjectOrderField)
import Dillonkearns.Examples.Github.Enum.PullRequestOrderField
  (PullRequestOrderField)
import Dillonkearns.Examples.Github.Enum.ReactionOrderField (ReactionOrderField)
import Dillonkearns.Examples.Github.Enum.RefOrderField (RefOrderField)
import Dillonkearns.Examples.Github.Enum.ReleaseOrderField (ReleaseOrderField)
import Dillonkearns.Examples.Github.Enum.RepositoryInvitationOrderField
  (RepositoryInvitationOrderField)
import Dillonkearns.Examples.Github.Enum.RepositoryOrderField
  (RepositoryOrderField)
import Dillonkearns.Examples.Github.Enum.SavedReplyOrderField
  (SavedReplyOrderField)
import Dillonkearns.Examples.Github.Enum.SecurityAdvisoryIdentifierType
  (SecurityAdvisoryIdentifierType)
import Dillonkearns.Examples.Github.Enum.SecurityAdvisoryOrderField
  (SecurityAdvisoryOrderField)
import Dillonkearns.Examples.Github.Enum.SecurityVulnerabilityOrderField
  (SecurityVulnerabilityOrderField)
import Dillonkearns.Examples.Github.Enum.SamlSignatureAlgorithm
  (SamlSignatureAlgorithm)
import Dillonkearns.Examples.Github.Enum.SamlDigestAlgorithm
  (SamlDigestAlgorithm)
import Dillonkearns.Examples.Github.Enum.RepositoryInteractionLimit
  (RepositoryInteractionLimit)
import Dillonkearns.Examples.Github.Enum.RepositoryInteractionLimitExpiry
  (RepositoryInteractionLimitExpiry)
import Dillonkearns.Examples.Github.Enum.SponsorableOrderField
  (SponsorableOrderField)
import Dillonkearns.Examples.Github.Enum.SponsorsTierOrderField
  (SponsorsTierOrderField)
import Dillonkearns.Examples.Github.Enum.SponsorshipOrderField
  (SponsorshipOrderField)
import Dillonkearns.Examples.Github.Enum.StarOrderField (StarOrderField)
import Dillonkearns.Examples.Github.Enum.TeamDiscussionCommentOrderField
  (TeamDiscussionCommentOrderField)
import Dillonkearns.Examples.Github.Enum.TeamDiscussionOrderField
  (TeamDiscussionOrderField)
import Dillonkearns.Examples.Github.Enum.TeamMemberOrderField
  (TeamMemberOrderField)
import Dillonkearns.Examples.Github.Enum.TeamOrderField (TeamOrderField)
import Dillonkearns.Examples.Github.Enum.TeamRepositoryOrderField
  (TeamRepositoryOrderField)
import Dillonkearns.Examples.Github.Enum.EnterpriseEnabledDisabledSettingValue
  (EnterpriseEnabledDisabledSettingValue)
import Dillonkearns.Examples.Github.Enum.EnterpriseDefaultRepositoryPermissionSettingValue
  (EnterpriseDefaultRepositoryPermissionSettingValue)
import Dillonkearns.Examples.Github.Enum.EnterpriseMembersCanCreateRepositoriesSettingValue
  (EnterpriseMembersCanCreateRepositoriesSettingValue)
import Dillonkearns.Examples.Github.Enum.EnterpriseMembersCanMakePurchasesSettingValue
  (EnterpriseMembersCanMakePurchasesSettingValue)
import Dillonkearns.Examples.Github.Enum.EnterpriseEnabledSettingValue
  (EnterpriseEnabledSettingValue)
import Dillonkearns.Examples.Github.Enum.IpAllowListEnabledSettingValue
  (IpAllowListEnabledSettingValue)
import Dillonkearns.Examples.Github.Enum.NotificationRestrictionSettingValue
  (NotificationRestrictionSettingValue)
import Dillonkearns.Examples.Github.Enum.ProjectState (ProjectState)
import Dillonkearns.Examples.Github.Enum.PullRequestUpdateState
  (PullRequestUpdateState)
import Dillonkearns.Examples.Github.Enum.SubscriptionState (SubscriptionState)
import Dillonkearns.Examples.Github.Enum.UserStatusOrderField
  (UserStatusOrderField)
import Dillonkearns.Examples.Github.Enum.VerifiableDomainOrderField
