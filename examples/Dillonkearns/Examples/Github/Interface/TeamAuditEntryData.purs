module Dillonkearns.Examples.Github.Interface.TeamAuditEntryData where
...
team
  ...
  -> SelectionSet Scope__TeamAuditEntryData (Maybe r)
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__TeamAuditEntryData decodesTo
...
maybeFragments = { onOrgRestoreMemberMembershipTeamAuditEntryData: pure
                                                                   Nothing
