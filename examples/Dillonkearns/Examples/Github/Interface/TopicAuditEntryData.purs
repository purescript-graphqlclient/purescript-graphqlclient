module Dillonkearns.Examples.Github.Interface.TopicAuditEntryData where
...
topic
  ...
  -> SelectionSet Scope__TopicAuditEntryData (Maybe r)
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__TopicAuditEntryData decodesTo
