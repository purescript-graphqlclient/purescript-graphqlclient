module Dillonkearns.Examples.Github.Interface.PackageOwner where
...
import Dillonkearns.Examples.Github.InputObject (PackageOrder) as Dillonkearns.Examples.Github.InputObject
...
packages
  ...
  -> SelectionSet Scope__PackageOwner r
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__PackageOwner decodesTo
