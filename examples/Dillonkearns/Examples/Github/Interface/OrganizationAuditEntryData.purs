module Dillonkearns.Examples.Github.Interface.OrganizationAuditEntryData where
...
import Dillonkearns.Examples.Github.Scopes
  ( Scope__Organization
  , Scope__OrganizationAuditEntryData
...
organization
  ...
  -> SelectionSet Scope__OrganizationAuditEntryData (Maybe r)
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__OrganizationAuditEntryData decodesTo
...
maybeFragments = { onMembersCanDeleteReposClearAuditEntry: pure
                 ...
                 , onOrgRestoreMemberAuditEntry: pure
                                                 Nothing
                 , onOrgRestoreMemberMembershipOrganizationAuditEntryData: pure
                                                                           Nothing
