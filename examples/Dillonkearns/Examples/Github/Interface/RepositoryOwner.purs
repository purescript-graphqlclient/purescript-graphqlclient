module Dillonkearns.Examples.Github.Interface.RepositoryOwner where
...
import Dillonkearns.Examples.Github.Scalars (Uri, Id)
...
repository
  ...
  -> SelectionSet Scope__RepositoryOwner (Maybe r)
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__RepositoryOwner decodesTo
