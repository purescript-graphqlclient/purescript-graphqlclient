module Dillonkearns.Examples.Github.Interface.MemberStatusable where
...
import Dillonkearns.Examples.Github.InputObject (UserStatusOrder) as Dillonkearns.Examples.Github.InputObject
