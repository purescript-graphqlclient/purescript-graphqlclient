module Dillonkearns.Examples.Github.Interface.GitSignature where
...
signer
  ...
  -> SelectionSet Scope__GitSignature (Maybe r)
...
type Fragments decodesTo
  = { onGpgSignature :: SelectionSet Scope__GpgSignature decodesTo
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__GitSignature decodesTo
