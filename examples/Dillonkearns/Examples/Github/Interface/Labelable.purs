module Dillonkearns.Examples.Github.Interface.Labelable where
...
import Dillonkearns.Examples.Github.InputObject (LabelOrder) as Dillonkearns.Examples.Github.InputObject
