module Dillonkearns.Examples.Github.Interface.RepositoryAuditEntryData where
...
repository
  ...
  -> SelectionSet Scope__RepositoryAuditEntryData (Maybe r)
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__RepositoryAuditEntryData decodesTo
