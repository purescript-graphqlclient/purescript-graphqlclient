module Dillonkearns.Examples.Github.Query where
...
import Dillonkearns.Examples.Github.Scalars (Id, Uri, DateTime)
import Dillonkearns.Examples.Github.Enum.SearchType (SearchType)
...
import Dillonkearns.Examples.Github.Enum.SecurityAdvisorySeverity
...
type SecurityAdvisoriesInputRowOptional r
  = ( orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.SecurityAdvisoryOrder
    , identifier
      :: Optional
         Dillonkearns.Examples.Github.InputObject.SecurityAdvisoryIdentifierFilter
...
type SecurityVulnerabilitiesInputRowOptional r
  = ( orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.SecurityVulnerabilityOrder
...
type SponsorablesInputRowOptional r
  = ( after :: Optional String
    ...
    , orderBy
      :: Optional
         Dillonkearns.Examples.Github.InputObject.SponsorableOrder
