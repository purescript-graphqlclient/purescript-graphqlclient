module Dillonkearns.Examples.Github.Union.PullRequestTimelineItems where
...
import Dillonkearns.Examples.Github.Scopes
  ...
  , Scope__AutoMergeDisabledEvent
  , Scope__AutoMergeEnabledEvent
  , Scope__AutoRebaseEnabledEvent
  , Scope__AutoSquashEnabledEvent
...
type Fragments decodesTo
  = { onAddedToProjectEvent :: SelectionSet Scope__AddedToProjectEvent decodesTo
    ...
    , onBaseRefDeletedEvent :: SelectionSet Scope__BaseRefDeletedEvent decodesTo
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__PullRequestTimelineItems decodesTo
fragments selections = exhaustiveFragmentSelection
                       ...
                       , buildFragment
                         ...
                         selections.onAutoMergeDisabledEvent
                       , buildFragment
                         "AutoMergeEnabledEvent"
                         selections.onAutoMergeEnabledEvent
                       , buildFragment
                         "AutoRebaseEnabledEvent"
                         selections.onAutoRebaseEnabledEvent
                       , buildFragment
                         "AutoSquashEnabledEvent"
                         selections.onAutoSquashEnabledEvent
                       , buildFragment
                       ...
                       , buildFragment
                         ...
                         selections.onPullRequestRevisionMarker
                       , buildFragment
                         "ReadyForReviewEvent"
...
maybeFragments = { onAddedToProjectEvent: pure
                 ...
                 , onAssignedEvent: pure
                                    Nothing
                 , onAutoMergeDisabledEvent: pure
                                             Nothing
                 , onAutoMergeEnabledEvent: pure
                                            Nothing
                 , onAutoRebaseEnabledEvent: pure
                                             Nothing
                 , onAutoSquashEnabledEvent: pure
                                             Nothing
                 ...
                 , onPullRequestReviewThread: pure
                                              Nothing
                 , onPullRequestRevisionMarker: pure
                                                Nothing
