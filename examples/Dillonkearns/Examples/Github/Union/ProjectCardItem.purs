module Dillonkearns.Examples.Github.Union.ProjectCardItem where

import Dillonkearns.GraphQLClient
  (SelectionSet, exhaustiveFragmentSelection, buildFragment)
import Dillonkearns.Examples.Github.Scopes
  (Scope__Issue, Scope__PullRequest, Scope__ProjectCardItem)
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__ProjectCardItem decodesTo
