module Dillonkearns.Examples.Github.Union.CreatedIssueOrRestrictedContribution where
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__CreatedIssueOrRestrictedContribution decodesTo
