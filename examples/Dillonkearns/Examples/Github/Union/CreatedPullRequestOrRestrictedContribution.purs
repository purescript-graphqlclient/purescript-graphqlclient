module Dillonkearns.Examples.Github.Union.CreatedPullRequestOrRestrictedContribution where
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__CreatedPullRequestOrRestrictedContribution decodesTo
