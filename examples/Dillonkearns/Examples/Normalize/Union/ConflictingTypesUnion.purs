module Dillonkearns.Examples.Normalize.Union.ConflictingTypesUnion where
...
type Fragments decodesTo
  = { onCat :: SelectionSet Scope__Cat decodesTo
...
fragments
  :: forall decodesTo
   . Fragments decodesTo
  -> SelectionSet Scope__ConflictingTypesUnion decodesTo
