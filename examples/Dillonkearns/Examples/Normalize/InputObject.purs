module Dillonkearns.Examples.Normalize.InputObject where

import Dillonkearns.GraphQLClient
  (Optional, class ToGraphQLArgumentValue, toGraphQLArgumentValue)
import Data.Generic.Rep (class Generic)
import Data.Newtype (class Newtype)
import Dillonkearns.Examples.Normalize.Enum.Language (Language)
...
instance toGraphQLArgumentValueCircularOne
  :: ToGraphQLArgumentValue CircularOne where
...
instance toGraphQLArgumentValueCircularTwo
  :: ToGraphQLArgumentValue CircularTwo where
...
instance toGraphQLArgumentValueRecursive
  :: ToGraphQLArgumentValue Recursive where
...
instance toGraphQLArgumentValueReservedWord
  :: ToGraphQLArgumentValue ReservedWord where
