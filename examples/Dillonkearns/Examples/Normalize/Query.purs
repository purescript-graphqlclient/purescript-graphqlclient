module Dillonkearns.Examples.Normalize.Query where

import Dillonkearns.Examples.Normalize.InputObject
  (CircularOne, Greeting, Recursive, ReservedWord) as Dillonkearns.Examples.Normalize.InputObject
...
import Dillonkearns.Examples.Normalize.Scopes
...
type CircularInputInputRowRequired r
  = ( input :: Dillonkearns.Examples.Normalize.InputObject.CircularOne | r )
...
type GreetInputRowRequired r
  = ( input :: Dillonkearns.Examples.Normalize.InputObject.Greeting | r )
...
type RecursiveInputInputRowRequired r
  = ( input :: Dillonkearns.Examples.Normalize.InputObject.Recursive | r )
...
type TypeInputRowOptional r
  = ( input :: Optional Dillonkearns.Examples.Normalize.InputObject.ReservedWord
    | r
    )
