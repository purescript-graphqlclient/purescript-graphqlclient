module Dillonkearns.Examples.SwapiCustomScalars where

import Data.Newtype (class Newtype)
import Dillonkearns.GraphQLClient (class GraphQLDefaultResponseScalarDecoder, class ToGraphQLArgumentValue, ArgumentValue(..))
import Prelude
