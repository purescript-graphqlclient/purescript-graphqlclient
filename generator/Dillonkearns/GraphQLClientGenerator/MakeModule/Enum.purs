module Dillonkearns.GraphQLClientGenerator.MakeModule.Enum where
...
import Dillonkearns.GraphQLClientGenerator.IntrospectionSchema (InstorpectionQueryResult__EnumValue, InstorpectionQueryResult__FullType)
