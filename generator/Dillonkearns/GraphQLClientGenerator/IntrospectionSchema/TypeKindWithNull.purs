module Dillonkearns.GraphQLClientGenerator.IntrospectionSchema.TypeKindWithNull where
...
type InstorpectionQueryResult__TypeRef_shared r
...
collectTypeRefInfo = map convertTypeKindWithNonNullToNull <<< convToWithNonNull
  ...
  convertTypeKindWithNonNullToNull = case _ of
    TypeKindWithNameWithNonNull__NonNull type_ -> case convertTypeKindWithNonNullToNull type_ of
  ...
  without typeRef = case typeRef.kind of
    NonNull -> Nothing
    List -> Nothing
  ...
  with handle typeRef = case typeRef.kind of
