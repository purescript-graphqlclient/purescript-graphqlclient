module Dillonkearns.GraphQLClientGenerator.IntrospectionSchema.TypeKind where

import Prelude
import Data.Generic.Rep (class Generic) as GenericRep
import Data.Show.Generic (genericShow) as GenericRep
import Dillonkearns.GraphQLClient.GraphQLEnum as GraphQLClient.GraphQLEnum
