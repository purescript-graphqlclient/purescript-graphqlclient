module Dillonkearns.GraphQLClientGenerator.IntrospectionSchema where

import Prelude
import Data.Argonaut.Decode (JsonDecodeError(..))
import Data.Either (note)
import Data.Maybe (Maybe)
import Dillonkearns.GraphQLClient.Implementation (Scope__RootQuery, SelectionSet, bindSelectionSet)
import Dillonkearns.GraphQLClient.WriteGraphQLHash (Cache)
import Dillonkearns.GraphQLClientGenerator.IntrospectionSchema.Fields (__schema, mutationType, mutationType_name, queryType, queryType_name, subscriptionType, subscriptionType_name, types, types_description, types_enumValues, types_enumValues_deprecationReason, types_enumValues_description, types_enumValues_isDeprecated, types_enumValues_name, types_fields, types_fields_args, types_fields_deprecationReason, types_fields_description, types_fields_isDeprecated, types_fields_name, types_fields_type, types_inputFields, types_interfaces, types_kind, types_name, types_possibleTypes)
import Dillonkearns.GraphQLClientGenerator.IntrospectionSchema.Fields.InputValue as GraphQLClientGenerator.IntrospectionSchema.Fields.InputValue
import Dillonkearns.GraphQLClientGenerator.IntrospectionSchema.Fields.TypeRef as GraphQLClientGenerator.IntrospectionSchema.Fields.TypeRef
import Dillonkearns.GraphQLClientGenerator.IntrospectionSchema.TypeKind (TypeKind)
import Dillonkearns.GraphQLClientGenerator.IntrospectionSchema.TypeKindWithNull (InstorpectionQueryResult__TypeRef, InstorpectionQueryResult__TypeRef_shared, TypeKindWithNull, collectTypeRefInfo)
...
inputValueFragment fieldNameFn =
  { name: _, description: _, type: _, defaultValue: _ }
  ...
  __schema fieldNameFn ado
    ...
    types' <-
      types fieldNameFn ado
        ...
        types_enumValues' <-
          types_enumValues fieldNameFn ({ includeDeprecated })
            $ { name: _
              , description: _
              , isDeprecated: _
              , deprecationReason: _
