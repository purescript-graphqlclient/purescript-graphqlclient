module Dillonkearns.MyExamplesTests.Example08Foldr where

import Control.Monad.Error.Class (throwError)
import Effect.Exception (error)
import Dillonkearns.Examples.Github.Scopes (Scope__Repository)
import Dillonkearns.MyExamplesTests.Util (inlineAndTrim)
import Dillonkearns.GraphQLClient (GraphQLError, Scope__RootQuery, SelectionSet, defaultInput, defaultRequestOptions, graphqlQueryRequest, nonNullOrFail, printGraphQLError, writeGraphQL)
import Prelude
