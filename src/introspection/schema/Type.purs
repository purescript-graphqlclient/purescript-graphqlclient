...
interfaces (SelectionSet fields' _) =
  SelectionSet
    [Composite "interfaces" [] fields'] RProxy
...
possibleTypes (SelectionSet fields' _) =
  SelectionSet
    [Composite "possibleTypes" [] fields'] RProxy
...
inputFields (SelectionSet fields' _) =
  SelectionSet [Composite "inputFields" [] fields'] RProxy

ofType ::
  forall r.
  SelectionSet r Type ->
  SelectionSet (ofType :: Record r) Type
ofType (SelectionSet fields' _) =
  SelectionSet [Composite "ofType" [] fields'] RProxy
